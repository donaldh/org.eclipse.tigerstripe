 ...
 * </copyright>
 *
 * $Id: DesignNotesFactoryImpl.java,v 1.1 2008/06/11 23:31:30 edillon Exp $
 */
...
public class DesignNotesFactoryImpl extends EFactoryImpl implements DesignNotesFactory {
	...
	public static DesignNotesFactory init() {
		try {
			DesignNotesFactory theDesignNotesFactory = (DesignNotesFactory)EPackage.Registry.INSTANCE.getEFactory("http:///org/eclipse/tigerstripe/annotation/example/designNotes.ecore"); 
