...
(cd target/
 ...
 "$MAVEN_HOME"/bin/mvn -X -fae -Dtycho.showEclipseLog=true -Dmaven.test.skip=false -Dcom.xored.q7.location=/auto/surf-tp/xmp-sdk/q7/eclipse.exe -Dosgi.os=linux -Dosgi.ws=gtk -Dosgi.arch=x86 -Dcom.xored.directorPlatformPath=/auto/surf-tp/xmp-sdk/eclipse install
 cd ..
