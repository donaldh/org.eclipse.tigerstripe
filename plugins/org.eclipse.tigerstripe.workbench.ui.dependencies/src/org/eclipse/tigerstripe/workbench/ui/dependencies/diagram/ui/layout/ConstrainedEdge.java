...
/**
 * Implementation of Edge that: <li>Can connect border node(s) <li>Can be routed
	...
	public ConstrainedEdge(Object data, Node source, Node target) {
		...
		if (this.source.equals(this.target)) {
			throw new RuntimeException(
					"Edges between border nodes on the same parent or border node and its parent are disallowed."); //$NON-NLS-1$
		}
	}
