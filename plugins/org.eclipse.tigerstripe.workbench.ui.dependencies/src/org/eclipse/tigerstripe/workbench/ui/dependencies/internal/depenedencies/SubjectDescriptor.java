...
public class SubjectDescriptor {
	...
	private final IDependencySubject externalSubject;
	private final Subject subject;

	public SubjectDescriptor(IDependencySubject externalSubject, Subject subject) {
		this.externalSubject = externalSubject;
		this.subject = subject;
	}

	public IDependencySubject getExternalSubject() {
