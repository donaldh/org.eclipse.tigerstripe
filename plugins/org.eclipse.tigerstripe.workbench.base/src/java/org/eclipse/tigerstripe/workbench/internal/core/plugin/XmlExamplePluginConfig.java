...
public class XmlExamplePluginConfig extends PluginConfig {

	public final static XmlExamplePluginConfig MODEL = new XmlExamplePluginConfig(
			null);
	...
	/* package */XmlExamplePluginConfig(TigerstripeProject project) {
		super(project);
	}
