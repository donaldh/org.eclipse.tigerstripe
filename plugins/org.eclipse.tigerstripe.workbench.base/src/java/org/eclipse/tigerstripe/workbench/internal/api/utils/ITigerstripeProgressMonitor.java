 ...
 *******************************************************************************/
package org.eclipse.tigerstripe.workbench.internal.api.utils;

/**
 * This Progress monitor interface is similar to the IProgressMonitor from
 * Eclipse, but avoids having references to Eclipse in this plugin so we can
 * still run headless.
 * 
 * @author Eric Dillon
 * 
 */
public interface ITigerstripeProgressMonitor {
	/**
