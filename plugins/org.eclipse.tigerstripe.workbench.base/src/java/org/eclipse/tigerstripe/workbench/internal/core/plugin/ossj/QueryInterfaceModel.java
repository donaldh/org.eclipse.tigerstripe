 ...
 */
public class QueryInterfaceModel extends OssjInterfaceModel {

	private final static String TEMPLATE = "queryInterface.vm";

	public QueryInterfaceModel(AbstractArtifact artifact, PluginConfig pluginConfig)
