...
public class UML2InterfaceMapper extends UML2BaseMapper {

	public UML2InterfaceMapper(NamedElement namedElement, UML2MappingUtils utils) {
	...
	public UML2AnnotableElement mapToAnnotable(ModelImporterListener listener,
		...
		result.setAnnotationType(AnnotableElement.AS_SESSIONFACADE);
