...
public class DependencyArtifactAuditor extends AbstractArtifactAuditor
	...
	protected void checkSuitableEndTypes(IType aEndType, IType zEndType){
		if (! DependencyArtifact.isSuitableType(aEndType)){
			...
			TigerstripeProjectAuditor.reportError("The A End must be of a suitable Type. Dependency Ends may not be of type '"+typeLabel+ "'.", getIResource(),
					222);
		}
		if (! DependencyArtifact.isSuitableType(zEndType)){
			...
			TigerstripeProjectAuditor.reportError("The Z End must be of a suitable Type. Dependency Ends may not be of type '"+typeLabel+ "'.", getIResource(),
					222);
		}
	}
