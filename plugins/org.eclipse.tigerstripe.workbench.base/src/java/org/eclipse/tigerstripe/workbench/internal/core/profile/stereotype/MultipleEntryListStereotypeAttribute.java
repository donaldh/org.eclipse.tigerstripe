 ...
 * 
 */
public class MultipleEntryListStereotypeAttribute extends BaseStereotypeAttribute
		implements IEntryListStereotypeAttribute {

	private SortedSet<String> entries = new TreeSet<String>();

	public MultipleEntryListStereotypeAttribute() {
		super(IStereotypeAttribute.MULTIPLE_ENTRY_LIST_KIND);
	}
