 ...
 */
public class EventInterfaceModel extends OssjInterfaceModel {

	private final static String TEMPLATE = "eventInterface.vm";

	protected EventInterfaceModel(AbstractArtifact artifact, PluginConfig pluginConfig)
