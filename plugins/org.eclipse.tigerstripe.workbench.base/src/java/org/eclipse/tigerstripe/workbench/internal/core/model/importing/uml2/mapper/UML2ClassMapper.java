...
public class UML2ClassMapper extends UML2BaseMapper {

	public UML2ClassMapper(NamedElement namedElement, UML2MappingUtils utils) {
	...
	public UML2AnnotableElement mapToAnnotable(ModelImporterListener listener,
		...
		result.setAbstract(((Classifier) namedElement).isAbstract());

		utils.setAttributes(result, namedElement);

		utils.setOperations(result, namedElement);
