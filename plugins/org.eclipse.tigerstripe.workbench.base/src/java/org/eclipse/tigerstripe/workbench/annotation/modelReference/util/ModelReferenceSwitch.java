 ...
 * </copyright>
 *
 * $Id: ModelReferenceSwitch.java,v 1.2 2011/12/01 15:24:06 verastov Exp $
 */
 ...
 * @generated
 */
public class ModelReferenceSwitch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ModelReferencePackage.MODEL_REFERENCE: {
