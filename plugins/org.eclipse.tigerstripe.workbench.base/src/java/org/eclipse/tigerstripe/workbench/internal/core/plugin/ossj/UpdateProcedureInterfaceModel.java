 ...
 */
public class UpdateProcedureInterfaceModel extends OssjInterfaceModel {

	private final static String TEMPLATE = "updateProcedureInterface.vm";

	public UpdateProcedureInterfaceModel(AbstractArtifact artifact,
