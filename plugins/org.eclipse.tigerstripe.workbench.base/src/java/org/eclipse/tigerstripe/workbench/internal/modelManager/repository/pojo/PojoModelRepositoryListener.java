...
import org.eclipse.tigerstripe.workbench.internal.modelManager.repository.pojo.command.RenamePojoCommand;
import org.eclipse.tigerstripe.workbench.internal.modelManager.repository.pojo.command.SaveToPojoCommand;

public class PojoModelRepositoryListener extends ResourceSetListenerImpl
		implements ResourceSetListener {

	private PojoModelRepository repository;

	public PojoModelRepositoryListener() {
		this(null);
	}

	public PojoModelRepositoryListener(PojoModelRepository repository) {
