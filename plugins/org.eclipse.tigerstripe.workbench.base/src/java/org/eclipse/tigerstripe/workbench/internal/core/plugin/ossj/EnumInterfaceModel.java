 ...
 */
public class EnumInterfaceModel extends OssjInterfaceModel {

	private final static String TEMPLATE = "enumInterface.vm";

	protected EnumInterfaceModel(AbstractArtifact artifact, PluginConfig pluginConfig)
