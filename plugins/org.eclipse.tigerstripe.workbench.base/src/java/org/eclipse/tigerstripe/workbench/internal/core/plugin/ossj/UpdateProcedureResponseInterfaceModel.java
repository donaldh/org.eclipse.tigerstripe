 ...
 */
public class UpdateProcedureResponseInterfaceModel extends OssjInterfaceModel {

	private final static String TEMPLATE = "updateProcedureResponseInterface.vm";

	public UpdateProcedureResponseInterfaceModel(AbstractArtifact artifact,
	...
	protected String getDefaultName() {
		return getArtifact().getName() + "Response";
	}
