 ...
 */
public class EventDescriptorInterfaceModel extends EventInterfaceModel {

	private final static String TEMPLATE = "eventDescriptorInterface.vm";

	protected EventDescriptorInterfaceModel(AbstractArtifact artifact,
	...
	protected String getDefaultName() {
		return super.getDefaultName() + "PropertyDescriptor";
	}
