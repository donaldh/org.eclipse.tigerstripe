 ...
 */
public class QueryResponseInterfaceModel extends OssjInterfaceModel {

	private final static String TEMPLATE = "queryResponseInterface.vm";

	public QueryResponseInterfaceModel(AbstractArtifact artifact,
