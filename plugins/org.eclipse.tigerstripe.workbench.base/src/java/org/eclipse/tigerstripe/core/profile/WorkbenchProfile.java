 ...
 *******************************************************************************/
package org.eclipse.tigerstripe.core.profile;
...
import org.eclipse.tigerstripe.core.model.Method.ReturnTypeWrapper;
...
public class WorkbenchProfile implements IWorkbenchProfile {
	...
	public IStereotype[] getAvailableStereotypeForCapable(
		...
		for (IStereotype stereotype : stereotypes) {
			...
			IextStereotypeScopeDetails details = stereotype
