...
public class InstanceEditPartFactory implements EditPartFactory {
	...
	public EditPart createEditPart(EditPart context, Object model) {
		if (model instanceof View) {
			...
			int viewVisualID = InstanceVisualIDRegistry.getVisualID(view);
			switch (viewVisualID) {
			case ClassInstanceEditPart.VISUAL_ID:
				return new ClassInstanceEditPart(view);
			case ClassInstanceNamePackageArtifactNameEditPart.VISUAL_ID:
				return new ClassInstanceNamePackageArtifactNameEditPart(view);
			case VariableEditPart.VISUAL_ID:
				return new VariableEditPart(view);
			case ClassInstanceVariableCompartmentEditPart.VISUAL_ID:
				return new ClassInstanceVariableCompartmentEditPart(view);
			case InstanceMapEditPart.VISUAL_ID:
				return new InstanceMapEditPart(view);
			...
			case AssociationInstanceNamePackageArtifactNameEditPart.VISUAL_ID:
				return new AssociationInstanceNamePackageArtifactNameEditPart(
						view);
			case AssociationInstanceAEndMultiplicityLowerBoEditPart.VISUAL_ID:
				return new AssociationInstanceAEndMultiplicityLowerBoEditPart(
						view);
			case AssociationInstanceAEndNameEditPart.VISUAL_ID:
				return new AssociationInstanceAEndNameEditPart(view);
			case AssociationInstanceZEndMultiplicityLowerBoEditPart.VISUAL_ID:
				return new AssociationInstanceZEndMultiplicityLowerBoEditPart(
						view);
			case AssociationInstanceZEndNameEditPart.VISUAL_ID:
				return new AssociationInstanceZEndNameEditPart(view);
			}
		}
