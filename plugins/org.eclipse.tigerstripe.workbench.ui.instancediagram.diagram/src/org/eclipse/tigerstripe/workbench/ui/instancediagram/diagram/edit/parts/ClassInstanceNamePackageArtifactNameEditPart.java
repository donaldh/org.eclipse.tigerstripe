...
public class ClassInstanceNamePackageArtifactNameEditPart extends
	...
	protected Image getLabelIcon() {
		ImageDescriptor descriptor = InstanceDiagramEditorPlugin.getInstance()
	...
	protected String getLabelText() {
		...
		ClassInstance instance = (ClassInstance) ((NodeImpl) this.getModel())
				.getElement();
			...
			ParserHintAdapter hintAdapter = new ParserHintAdapter(
				...
				public Object getAdapter(Class adapter) {
					if (IElementType.class.equals(adapter))
						return InstanceElementTypes.ClassInstance_1001;
	...
	protected void refreshUnderline() {
		...
		// }
		((WrapLabel) getFigure()).setTextUnderline(true);
	}
