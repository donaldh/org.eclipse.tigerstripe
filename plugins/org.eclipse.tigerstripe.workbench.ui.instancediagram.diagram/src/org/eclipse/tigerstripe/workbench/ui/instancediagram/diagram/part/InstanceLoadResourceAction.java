 ...
 * @generated
 */
public class InstanceLoadResourceAction implements IObjectActionDelegate {

	/**
	 * @generated
	 */
	private InstanceMapEditPart mySelectedElement;
	...
	public void selectionChanged(IAction action, ISelection selection) {
		...
		if (selection instanceof IStructuredSelection) {
			...
			if (structuredSelection.size() == 1
					&& structuredSelection.getFirstElement() instanceof InstanceMapEditPart) {
				mySelectedElement = (InstanceMapEditPart) structuredSelection
						.getFirstElement();
			}
		}
