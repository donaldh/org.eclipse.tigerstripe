...
import org.eclipse.tigerstripe.workbench.ui.instancediagram.diagram.edit.helpers.InstanceBaseEditHelper;

/**
 * @generated
 */
public class InstanceBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	...
	protected Command getSemanticCommand(IEditCommandRequest request) {
		...
		if (epCommand != null) {
			...
			completedRequest.setParameter(
					InstanceBaseEditHelper.EDIT_POLICY_COMMAND, command);
		}
