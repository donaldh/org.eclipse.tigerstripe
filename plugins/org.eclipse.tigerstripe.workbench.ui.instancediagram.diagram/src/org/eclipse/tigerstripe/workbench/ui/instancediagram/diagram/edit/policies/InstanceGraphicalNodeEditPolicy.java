...
import org.eclipse.tigerstripe.workbench.ui.instancediagram.diagram.edit.commands.InstanceReorientConnectionViewCommand;

/**
 * @generated
 */
public class InstanceGraphicalNodeEditPolicy extends GraphicalNodeEditPolicy {
	...
	protected Command getConnectionWithReorientedViewCompleteCommand(
		...
		TransactionalEditingDomain editingDomain = ((IGraphicalEditPart) getHost())
				.getEditingDomain();
		InstanceReorientConnectionViewCommand rcvCommand = new InstanceReorientConnectionViewCommand(
				editingDomain, null);
