...
public class AssociationInstanceZEndNameEditPart extends LabelEditPart
	 ...
	 */
	static {
		registerSnapBackPosition(InstanceVisualIDRegistry
	 ...
	 * @generated
	 */
	public AssociationInstanceZEndNameEditPart(View view) {
		super(view);
	}
	...
	protected String getLabelText() {
		...
		if (NamedElementPropertiesHelper.ASSOC_SHOW_NONE.equals(detailsProp)) {
			return "";
				...
				.equals(detailsProp))
				&& isZEndIsOrdered(instance)) {
			String order = instance.getZEndOrder();
			if (order != null) {
				result.append("{order=");
				result.append(order);
				result.append("} ");
	...
	private boolean isZEndIsOrdered(AssociationInstance association) {
	...
	protected IFigure createFigurePrim() {
		return new AssociationInstanceZEndNameFigure();
	}

	/**
	 * @generated
	 */
	public class AssociationInstanceZEndNameFigure extends
			org.eclipse.gmf.runtime.draw2d.ui.figures.WrapLabel {

		/**
		 * @generated NOT
		 */
		public AssociationInstanceZEndNameFigure() {
