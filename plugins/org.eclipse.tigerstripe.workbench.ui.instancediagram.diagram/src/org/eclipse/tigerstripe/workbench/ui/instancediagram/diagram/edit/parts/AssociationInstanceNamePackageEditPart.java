 ...
 * @generated
 */
public class AssociationInstanceNamePackageEditPart extends LabelEditPart
	...
	static {
		registerSnapBackPosition(InstanceVisualIDRegistry
				.getType(AssociationInstanceNamePackageEditPart.VISUAL_ID),
				new Point(0, -15));
	}
	 ...
	 * @generated
	 */
	public AssociationInstanceNamePackageEditPart(View view) {
		super(view);
	}
