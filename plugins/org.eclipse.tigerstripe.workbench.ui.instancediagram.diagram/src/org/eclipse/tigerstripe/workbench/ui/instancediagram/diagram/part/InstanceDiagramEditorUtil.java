 ...
 * @generated
 */
public class InstanceDiagramEditorUtil extends IDEEditorUtil {
	...
	public static final IFile createAndOpenDiagram(
		...
		IFile diagramFile = InstanceDiagramEditorUtil.createNewDiagramFile(
	...
	public static final IFile createNewDiagramFile(
		...
		IPath modelFileRelativePath = diagramFile.getFullPath()
				.removeFileExtension().addFileExtension("owm"); //$NON-NLS-1$
		...
		AbstractTransactionalCommand command = new AbstractTransactionalCommand(
			...
			protected CommandResult doExecuteWithResult(
				...
				InstanceMap model = createInitialModel();
	 ...
	 * @generated
	 */
	private static InstanceMap createInitialModel() {
		return InstancediagramFactory.eINSTANCE.createInstanceMap();
	}

	/**
	 * @generated
	 */
	private static EObject createInitialRoot(InstanceMap model) {
		return model;
	}
}
