 ...
 * </copyright>
 *
 * $Id: IModelComponentImpl.java,v 1.2 2008/02/22 20:01:22 edillon Exp $
 */
...
public abstract class IModelComponentImpl extends IStereotypeCapableImpl
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					MetamodelPackage.IMODEL_COMPONENT__NAME, oldName, name));
	}
	...
	public void setComment(String newComment) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					MetamodelPackage.IMODEL_COMPONENT__COMMENT, oldComment,
					comment));
	}
	...
	public void setVisibility(VisibilityEnum newVisibility) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					MetamodelPackage.IMODEL_COMPONENT__VISIBILITY,
