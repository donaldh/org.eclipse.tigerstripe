 ...
 * </copyright>
 *
 * $Id: ITypeImpl.java,v 1.1 2008/02/14 23:58:00 edillon Exp $
 */
...
public class ITypeImpl extends EObjectImpl implements IType {
	...
	public void setFullyQualifiedName(String newFullyQualifiedName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MetamodelPackage.ITYPE__FULLY_QUALIFIED_NAME, oldFullyQualifiedName, fullyQualifiedName));
	}
	...
	public IMultiplicity getMultiplicity() {
		if (multiplicity != null && multiplicity.eIsProxy()) {
			...
			if (multiplicity != oldMultiplicity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MetamodelPackage.ITYPE__MULTIPLICITY, oldMultiplicity, multiplicity));
			}
		}
		return multiplicity;
	}
	...
	public void setMultiplicity(IMultiplicity newMultiplicity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MetamodelPackage.ITYPE__MULTIPLICITY, oldMultiplicity, multiplicity));
	}
