 ...
 * </copyright>
 *
 * $Id: IQualifiedNamedComponentImpl.java,v 1.2 2008/02/28 18:05:31 edillon Exp $
 */
...
public abstract class IQualifiedNamedComponentImpl extends IModelComponentImpl
	...
	public void setPackage(String newPackage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MetamodelPackage.IQUALIFIED_NAMED_COMPONENT__PACKAGE, oldPackage, package_));
	}
