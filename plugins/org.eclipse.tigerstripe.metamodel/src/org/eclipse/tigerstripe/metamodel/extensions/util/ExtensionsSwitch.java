 ...
 * </copyright>
 *
 * $Id: ExtensionsSwitch.java,v 1.1 2008/02/14 23:58:01 edillon Exp $
 */
...
public class ExtensionsSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ExtensionsPackage.ISTANDARD_SPECIFICS: {
				IStandardSpecifics iStandardSpecifics = (IStandardSpecifics)theEObject;
				T result = caseIStandardSpecifics(iStandardSpecifics);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ExtensionsPackage.IPROPERTIES: {
				IProperties iProperties = (IProperties)theEObject;
				T result = caseIProperties(iProperties);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ExtensionsPackage.IPROPERTY: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>IProperties</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>IProperties</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseIProperties(IProperties object) {
		return null;
	}
