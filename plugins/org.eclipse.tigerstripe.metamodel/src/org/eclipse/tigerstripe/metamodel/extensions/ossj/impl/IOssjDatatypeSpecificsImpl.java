 ...
 * </copyright>
 *
 * $Id: IOssjDatatypeSpecificsImpl.java,v 1.1 2008/02/14 23:58:01 edillon Exp $
 */
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>IOssj Datatype Specifics</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.eclipse.tigerstripe.metamodel.extensions.ossj.impl.IOssjDatatypeSpecificsImpl#isSingleExtensionType <em>Single Extension Type</em>}</li>
 *   <li>{@link org.eclipse.tigerstripe.metamodel.extensions.ossj.impl.IOssjDatatypeSpecificsImpl#isSessionFactoryMethods <em>Session Factory Methods</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class IOssjDatatypeSpecificsImpl extends IOssjArtifactSpecificsImpl implements IOssjDatatypeSpecifics {
	/**
	 ...
	 * @generated
	 */
	protected IOssjDatatypeSpecificsImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return OssjPackage.Literals.IOSSJ_DATATYPE_SPECIFICS;
	}
	...
	public void setSingleExtensionType(boolean newSingleExtensionType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OssjPackage.IOSSJ_DATATYPE_SPECIFICS__SINGLE_EXTENSION_TYPE, oldSingleExtensionType, singleExtensionType));
	}
	...
	public void setSessionFactoryMethods(boolean newSessionFactoryMethods) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OssjPackage.IOSSJ_DATATYPE_SPECIFICS__SESSION_FACTORY_METHODS, oldSessionFactoryMethods, sessionFactoryMethods));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OssjPackage.IOSSJ_DATATYPE_SPECIFICS__SINGLE_EXTENSION_TYPE:
				return isSingleExtensionType() ? Boolean.TRUE : Boolean.FALSE;
			case OssjPackage.IOSSJ_DATATYPE_SPECIFICS__SESSION_FACTORY_METHODS:
