...
public abstract class AbstractArtifactWriter {
	...
	public void applyTemplate() throws ModelCoreException {
		try {
...
//			context.put("runtime", TigerstripeRuntime.getInstance()); FIXME
			...
			throw new ModelCoreException("Error while persisting artifact "
