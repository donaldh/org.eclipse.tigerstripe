...
public class DependencyArtifactReader extends ArtifactReader {
	...
	public IAbstractArtifact readArtifact() throws ModelCoreException {
		IDependencyArtifact result = MetamodelFactory.eINSTANCE
	...
	protected IAbstractArtifact makeProxyArtifact(String parentClass) {
		try {
			...
			((IDependencyArtifactImpl) result).eSetProxyURI(uri);
			return result;
