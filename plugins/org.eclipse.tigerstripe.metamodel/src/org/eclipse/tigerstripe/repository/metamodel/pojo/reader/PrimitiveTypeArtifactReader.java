...
public class PrimitiveTypeArtifactReader extends ArtifactReader {
	...
	public IAbstractArtifact readArtifact() throws ModelCoreException {
		IPrimitiveType result = MetamodelFactory.eINSTANCE
				.createIPrimitiveType();
	...
	protected IAbstractArtifact makeProxyArtifact(String parentClass) {
		try {
			...
			((IPrimitiveTypeImpl) result).eSetProxyURI(uri);
			return result;
