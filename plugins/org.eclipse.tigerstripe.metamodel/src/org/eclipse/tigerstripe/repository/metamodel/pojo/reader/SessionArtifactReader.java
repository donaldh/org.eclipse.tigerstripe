...
public class SessionArtifactReader extends ArtifactReader {
	...
	public IAbstractArtifact readArtifact() throws ModelCoreException {
		ISessionArtifact result = MetamodelFactory.eINSTANCE
	...
	protected IAbstractArtifact makeProxyArtifact(String parentClass) {
		try {
			...
			((ISessionArtifactImpl) result).eSetProxyURI(uri);
			return result;
