...
public class AssociationArtifactReader extends ArtifactReader {
	...
	public IAbstractArtifact readArtifact() throws ModelCoreException {
		IAssociationArtifact result = MetamodelFactory.eINSTANCE
	...
	protected IAbstractArtifact makeProxyArtifact(String parentClass) {
		try {
			...
			((IAssociationArtifactImpl) result).eSetProxyURI(uri);
			return result;
