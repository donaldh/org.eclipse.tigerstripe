...
public class UpdateProcedureArtifactReader extends ArtifactReader {
	...
	public IAbstractArtifact readArtifact() throws ModelCoreException {
		IUpdateProcedureArtifact result = MetamodelFactory.eINSTANCE
	...
	protected IAbstractArtifact makeProxyArtifact(String parentClass) {
		try {
			...
			((IUpdateProcedureArtifactImpl) result).eSetProxyURI(uri);
			return result;
