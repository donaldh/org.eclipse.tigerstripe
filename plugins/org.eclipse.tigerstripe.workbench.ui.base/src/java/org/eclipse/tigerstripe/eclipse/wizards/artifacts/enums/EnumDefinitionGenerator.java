 ...
 *******************************************************************************/
package org.eclipse.tigerstripe.eclipse.wizards.artifacts.enums;
 ...
 */
public class EnumDefinitionGenerator extends ArtifactDefinitionGenerator {

	private final static String TEMPLATE = VM_TEMPLATE_BASE + "enum.vm";
	 ...
	 */
	public EnumDefinitionGenerator(Properties properties, Writer writer) {
		super();
