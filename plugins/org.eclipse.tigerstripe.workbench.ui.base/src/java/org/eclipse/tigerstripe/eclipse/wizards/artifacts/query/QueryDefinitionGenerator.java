 ...
 *******************************************************************************/
package org.eclipse.tigerstripe.eclipse.wizards.artifacts.query;
 ...
 */
public class QueryDefinitionGenerator extends ArtifactDefinitionGenerator {

	private final static String TEMPLATE = VM_TEMPLATE_BASE + "query.vm";
	 ...
	 */
	public QueryDefinitionGenerator(Properties properties, Writer writer) {
		super();
