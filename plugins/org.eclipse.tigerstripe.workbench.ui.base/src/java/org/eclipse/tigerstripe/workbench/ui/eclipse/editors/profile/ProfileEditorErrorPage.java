...
public class ProfileEditorErrorPage extends TigerstripeFormPage {

	private IManagedForm managedForm = null;

	public ProfileEditorErrorPage(FormEditor editor, String id, String title) {
		super(editor, id, title);
		// TODO Auto-generated constructor stub
	}

	public ProfileEditorErrorPage(String id, String title) {
		super(id, title);
		// TODO Auto-generated constructor stub
	}
	...
	public void createFormContent(IManagedForm managedForm) {
		...
		ProfileEditorErrorPage profEditorErrPage = (ProfileEditorErrorPage) managedForm
				.getContainer();
		ProfileEditor profEditor = (ProfileEditor) profEditorErrPage
				.getEditor();
