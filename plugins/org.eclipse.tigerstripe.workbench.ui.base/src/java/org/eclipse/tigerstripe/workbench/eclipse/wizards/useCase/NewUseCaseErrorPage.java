 ...
 *******************************************************************************/
package org.eclipse.tigerstripe.workbench.eclipse.wizards.useCase;
...
public class NewUseCaseErrorPage extends WizardPage {

	public NewUseCaseErrorPage(String pageName) {
		super(pageName);
	}

	public NewUseCaseErrorPage(String pageName, String title,
	...
	public void createControl(Composite parent) {
		...
		warningLabel
				.setText("\nYou cannot create new Tigerstripe Workbench Use Case\n\n\n"
