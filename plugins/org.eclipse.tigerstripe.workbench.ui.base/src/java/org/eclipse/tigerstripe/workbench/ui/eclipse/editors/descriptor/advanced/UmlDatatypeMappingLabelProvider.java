...
public class UmlDatatypeMappingLabelProvider implements ITableLabelProvider {

	public UmlDatatypeMappingLabelProvider() {
		super();
	...
	public String getColumnText(Object element, int columnIndex) {
		UmlDatatypeMapping mapping = (UmlDatatypeMapping) element;

		switch (columnIndex) {
		case 0:
			return mapping.getUmlDatatype();
		case 1:
