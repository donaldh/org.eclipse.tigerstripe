 ...
 *******************************************************************************/
package org.eclipse.tigerstripe.workbench.eclipse.wizards.artifacts.datatype;
 ...
 */
public class DatatypeDefinitionGenerator extends ArtifactDefinitionGenerator {

	private final static String TEMPLATE = VM_TEMPLATE_BASE + "datatype.vm";
	 ...
	 */
	public DatatypeDefinitionGenerator(Properties properties, Writer writer) {
		super();
