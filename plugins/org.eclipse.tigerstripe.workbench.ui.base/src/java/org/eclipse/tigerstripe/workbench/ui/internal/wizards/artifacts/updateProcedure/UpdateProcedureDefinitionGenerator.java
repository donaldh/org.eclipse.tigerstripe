 ...
 *******************************************************************************/
package org.eclipse.tigerstripe.workbench.ui.internal.wizards.artifacts.updateProcedure;
 ...
 */
public class UpdateProcedureDefinitionGenerator extends
		ArtifactDefinitionGenerator {

	private final static String TEMPLATE = VM_TEMPLATE_BASE
			+ "updateProcedure.vm";
	 ...
	 */
	public UpdateProcedureDefinitionGenerator(Properties properties,
			Writer writer) {
		super();
