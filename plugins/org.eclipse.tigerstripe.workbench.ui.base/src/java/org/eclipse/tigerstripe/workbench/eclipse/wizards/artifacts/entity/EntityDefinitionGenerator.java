 ...
 *******************************************************************************/
package org.eclipse.tigerstripe.workbench.eclipse.wizards.artifacts.entity;
 ...
 */
public class EntityDefinitionGenerator extends ArtifactDefinitionGenerator {

	private final static String TEMPLATE = VM_TEMPLATE_BASE + "entity.vm";
	 ...
	 */
	public EntityDefinitionGenerator(Properties properties, Writer writer) {
		super();
