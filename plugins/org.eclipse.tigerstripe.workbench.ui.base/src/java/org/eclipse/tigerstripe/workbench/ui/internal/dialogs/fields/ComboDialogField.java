 ...
 *******************************************************************************/
package org.eclipse.tigerstripe.workbench.ui.internal.dialogs.fields;
 ...
 * 
 * This code was borrowed from JDT
 */
public class ComboDialogField extends DialogField {
	...
	public boolean selectItem(int index) {
		...
		if (isOkToUse(fComboControl)) {
			...
			if (success) {
				fSelectionIndex= index; // Necessary for Linux combo impl
			}
		} else {
