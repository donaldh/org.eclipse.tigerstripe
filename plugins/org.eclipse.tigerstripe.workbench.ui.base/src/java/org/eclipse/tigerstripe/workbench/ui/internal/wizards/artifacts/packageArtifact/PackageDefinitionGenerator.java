 ...
 */
public class PackageDefinitionGenerator extends ArtifactDefinitionGenerator {

	private final static String TEMPLATE = VM_TEMPLATE_BASE + "package.vm";
	 ...
	 */
	public PackageDefinitionGenerator(Properties properties, Writer writer) {
		super();
