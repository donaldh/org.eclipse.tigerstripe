...
/**
 * Introduced because of bugzilla 320048.  TS-specific action group for opening and closing projects in TS Explorer.
 * This is pretty much a duplicate of JDT's ProjectActionGroup.  The only difference is that it returns a TS-specific
 * action for opening closed projects 
 * 
 * @author N. Mehregani
 */
public class TSProjectActionGroup extends ActionGroup {
	...
	/**
	 * Creates a new <code>TSProjectActionGroup</code>. The group requires
	 * that the selection provided by the site's selection provider is of type <code>
	 * org.eclipse.jface.viewers.IStructuredSelection</code>.
	 *
	 * @param part the view part that owns this action group
	 */
	public TSProjectActionGroup(IViewPart part) {
	 ...
	 * @since 3.4
	 */
	public TSProjectActionGroup(IWorkbenchSite site, ISelectionProvider selectionProvider) {
