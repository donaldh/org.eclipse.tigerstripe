...
public class SegmentSourcePage extends TextEditor implements IFormPage,
		IGotoMarker {
	 ...
	 * 
	 */
	public SegmentSourcePage(SegmentEditor editor, String id, String title) {
		this.id = id;
		initialize(editor);
	...
	public void initialize(FormEditor editor) {
		this.editor = (SegmentEditor) editor;
	}
