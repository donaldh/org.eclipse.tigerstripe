 ...
 *******************************************************************************/
package org.eclipse.tigerstripe.workbench.eclipse.wizards.artifacts.associationClass;
...
public class NewAssociationClassWizardPage extends NewArtifactWizardPage {
	...
	private final static String PAGE_NAME = "NewAssociationClassWizardPage";
	...
	public NewAssociationClassWizardPage() {
		super(PAGE_NAME);

		setTitle("Association Class Artifact");
		setDescription("Create a new Association Class Artifact.");
