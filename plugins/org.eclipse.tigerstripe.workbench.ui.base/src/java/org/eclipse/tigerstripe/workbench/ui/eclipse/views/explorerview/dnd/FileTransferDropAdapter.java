 ...
 */
public class FileTransferDropAdapter extends JdtViewerDropAdapter implements
	...
	public boolean isEnabled(DropTargetEvent event) {
		return true;
		// TigerstripeRuntime.logInfoMessage("event = " + event.toString());
	...
	public void drop(Object dropTarget, final DropTargetEvent event) {
		try {
			...
			String title = "Error";// PackagesMessages.DropAdapter_errorTitle;
			String message = "Error"; // PackagesMessages.DropAdapter_errorMessage;
	...
	private IContainer getActualTarget(Object dropTarget)
		...
		if (dropTarget instanceof IContainer)
			...
			return getActualTarget(((IJavaElement) dropTarget)
