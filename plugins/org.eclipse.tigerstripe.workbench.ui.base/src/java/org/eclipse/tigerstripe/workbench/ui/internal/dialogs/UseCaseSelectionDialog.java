...
public class UseCaseSelectionDialog extends ElementTreeSelectionDialog {
	/**
	 * Constructor for FacetSelectionDialog.
	 */
	public UseCaseSelectionDialog(Shell parent, boolean multiSelect,
	...
	private static boolean isUseCaseFile(File file) {
		String name = file.getName();
		return name.endsWith("." + IUseCase.FILE_EXTENSION);
	}
