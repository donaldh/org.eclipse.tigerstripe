...
/**
 * A MultiActionGroup will display a list of IActions in a menu by transforming
 * them into MenuItems. The list of labels given will be what is displayed in
 * the ViewMenu for the corresponding action (the action at the same position in
 * the action array). The actions are currently implemented as state based so
 * that after an action is executed the label will have a selection check.
 * 
 * @since 2.1
 */
