 ...
 *******************************************************************************/
package org.eclipse.tigerstripe.workbench.ui.internal.editors.useCase;
...
public class UseCaseEditorErrorPage extends TigerstripeFormPage {

	private IManagedForm managedForm = null;

	public UseCaseEditorErrorPage(FormEditor editor, String id, String title) {
		super(editor, id, title);
		// TODO Auto-generated constructor stub
	}

	public UseCaseEditorErrorPage(String id, String title) {
		super(id, title);
		// TODO Auto-generated constructor stub
	}
	...
	public void createFormContent(IManagedForm managedForm) {
		...
		warningLabel
				.setText("\nYou cannot edit/view Tigerstripe Workbench Profiles\n\n\n"
						+ "Your Tigerstripe license has insufficient privileges for this operation, "
						+ "please contact Tigerstripe if you wish to edit/view Tigerstripe Profiles.");
		...
		UseCaseEditorErrorPage profEditorErrPage = (UseCaseEditorErrorPage) managedForm
				.getContainer();
		UseCaseEditor profEditor = (UseCaseEditor) profEditorErrPage
				.getEditor();
		CTabFolder folder = profEditor.getPageFolder();
