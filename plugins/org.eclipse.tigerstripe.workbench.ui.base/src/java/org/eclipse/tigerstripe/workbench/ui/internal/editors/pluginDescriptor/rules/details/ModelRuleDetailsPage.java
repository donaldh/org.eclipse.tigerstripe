...
public class ModelRuleDetailsPage extends BaseTemplateRuleDetailsPage {

	private Button suppressEmptyFilesButton;

	private Button overwriteFilesButton;

	public ModelRuleDetailsPage(RulesSectionPart master,
	...
	protected void handleSimpleWidgetSelected(SelectionEvent e) {
		if (!isSilentUpdate()) {
			if (e.getSource() == suppressEmptyFilesButton) {
				ModelTemplateRule rule = (ModelTemplateRule) getITemplateRunRule();
	...
	protected void createContents(Composite parent) {
		...
		Label label = getToolkit()
				.createLabel(sectionClient,
						"This template will be run once per model with this generator.");
