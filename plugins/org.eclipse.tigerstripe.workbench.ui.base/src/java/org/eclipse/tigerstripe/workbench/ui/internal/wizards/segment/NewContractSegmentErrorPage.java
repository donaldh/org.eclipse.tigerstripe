 ...
 *******************************************************************************/
package org.eclipse.tigerstripe.workbench.ui.internal.wizards.segment;
...
public class NewContractSegmentErrorPage extends WizardPage {

	public NewContractSegmentErrorPage(String pageName) {
		super(pageName);
	}

	public NewContractSegmentErrorPage(String pageName, String title,
	...
	public void createControl(Composite parent) {
		...
		warningLabel
				.setText("\nYou cannot create new Tigerstripe Workbench Profile\n\n\n"
						+ "Your Tigerstripe license has insufficient privileges for this operation, "
						+ "please contact Tigerstripe if you wish to create a new Workbench Profile.");
