...
import org.eclipse.tigerstripe.workbench.ui.internal.wizards.artifacts.exception.NewExceptionWizard;
 ...
 */
public class OpenNewPackageArtifactWizardAction extends
	...
	protected void initAction() {
		setText(ArtifactMetadataFactory.INSTANCE.getMetadata(
				...
				.getLabel(null));
		setImageDescriptor(Images.getDescriptor(Images.PACKAGE_ICON_NEW));
	}
