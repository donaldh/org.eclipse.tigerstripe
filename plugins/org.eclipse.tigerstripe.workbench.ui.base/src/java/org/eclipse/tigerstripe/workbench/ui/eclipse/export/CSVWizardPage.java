...
public class CSVWizardPage extends TSRuntimeBasedWizardPage {

	private final static String PAGE_NAME = "org.eclipse.tigerstripe.workbench.ui.eclipse.wizards.csv.page";

	public CSVWizardPage() {
		super(PAGE_NAME);

		setTitle("Create CSV from Tigerstripe Project");
		setDescription("This wizard Create a CSV of a Tigerstripe project.");
	}
	...
	public void createControl(Composite parent) {
		...
		msg
				.setText("CSV creation details must be set in the Project Descriptor (tigerstripe.xml).");
	...
	protected IStatus updatePage() {
		...
		IProjectCSVCreator creator = handle.getCSVCreator();
		if (!creator.isCSVCreateable()) {
			localStatus
					.setError("Please enable and fill in CSV create details in Project Descriptor (tigerstripe.xml).");
		}
