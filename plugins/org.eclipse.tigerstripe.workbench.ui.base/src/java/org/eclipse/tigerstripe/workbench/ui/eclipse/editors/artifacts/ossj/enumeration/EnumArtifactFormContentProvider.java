...
public class EnumArtifactFormContentProvider extends
	...
	public String getText(String textId) {
		if (IArtifactFormContentProvider.ARTIFACT_CONTENT_COMPONENTS
			...
			buf.append("<form>");
			buf
					.append("<li><a href=\"constants\">Constants</a>: Constants defined by this enumeration.</li>");
			buf.append("</form>");
