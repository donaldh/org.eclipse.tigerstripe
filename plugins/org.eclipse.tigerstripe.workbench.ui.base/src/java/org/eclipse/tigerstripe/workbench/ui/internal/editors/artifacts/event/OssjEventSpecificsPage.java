...
public class OssjEventSpecificsPage extends TigerstripeFormPage {

	private OssjEventDescriptorSection descriptorPart;
	...
	public OssjEventSpecificsPage(FormEditor editor,
	...
	private void fillBody(IManagedForm managedForm, FormToolkit toolkit) {
		...
		TigerstripeSectionPart part = new OssjEventSpecificsSection(this, body,
				toolkit, labelProvider, contentProvider);
		managedForm.addPart(part);

		descriptorPart = new OssjEventDescriptorSection(this, body, toolkit,
