...
public class XSLFileSelectionDialog extends ElementTreeSelectionDialog {
	/**
	 * Constructor for JARFileSelectionDialog.
	 */
	public XSLFileSelectionDialog(Shell parent, boolean multiSelect,
	...
	private static boolean isVelocityTemplate(File file) {
		...
		return name.endsWith(".xsl") || name.endsWith(".xml");
	}
