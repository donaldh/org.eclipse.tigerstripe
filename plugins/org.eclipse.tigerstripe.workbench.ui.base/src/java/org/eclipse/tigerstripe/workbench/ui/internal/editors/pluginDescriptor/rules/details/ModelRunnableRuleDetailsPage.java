...
public class ModelRunnableRuleDetailsPage extends BaseRunnableRuleDetailsPage {

	private Button suppressEmptyFilesButton;

	private Button overwriteFilesButton;

	public ModelRunnableRuleDetailsPage(RulesSectionPart master,
	 ...
	 */
	private class ModelRunnableRuleDetailsPageListener implements
	...
	protected void handleSimpleWidgetSelected(SelectionEvent e) {
		if (!isSilentUpdate()) {
			if (e.getSource() == suppressEmptyFilesButton) {
				ModelRunnableRule rule = (ModelRunnableRule) getIRunnableRule();
	...
	public void createContents(Composite parent) {
		...
		Label label = getToolkit().createLabel(sectionClient,
				"This rule will be run once per model with this generator.");
	...
	protected void createOptionButtons(Composite parent) {
		...
		ModelRunnableRuleDetailsPageListener adapter = new ModelRunnableRuleDetailsPageListener();
