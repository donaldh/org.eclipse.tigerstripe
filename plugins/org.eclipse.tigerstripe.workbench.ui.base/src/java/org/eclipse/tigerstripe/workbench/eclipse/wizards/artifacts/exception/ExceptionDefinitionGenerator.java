 ...
 *******************************************************************************/
package org.eclipse.tigerstripe.workbench.eclipse.wizards.artifacts.exception;
 ...
 */
public class ExceptionDefinitionGenerator extends ArtifactDefinitionGenerator {

	private final static String TEMPLATE = VM_TEMPLATE_BASE + "exception.vm";
	 ...
	 */
	public ExceptionDefinitionGenerator(Properties properties, Writer writer) {
		super();
