...
public class SegmentEditorErrorPage extends TigerstripeFormPage {

	private IManagedForm managedForm = null;

	public SegmentEditorErrorPage(FormEditor editor, String id, String title) {
		super(editor, id, title);
		// TODO Auto-generated constructor stub
	}

	public SegmentEditorErrorPage(String id, String title) {
		super(id, title);
		// TODO Auto-generated constructor stub
	}
	...
	public void createFormContent(IManagedForm managedForm) {
		...
		SegmentEditorErrorPage profEditorErrPage = (SegmentEditorErrorPage) managedForm
				.getContainer();
		SegmentEditor profEditor = (SegmentEditor) profEditorErrPage
				.getEditor();
