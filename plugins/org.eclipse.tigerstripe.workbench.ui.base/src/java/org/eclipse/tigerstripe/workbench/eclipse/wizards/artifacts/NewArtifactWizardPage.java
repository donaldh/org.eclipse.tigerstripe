...
import org.eclipse.tigerstripe.workbench.eclipse.wizards.WizardUtils;
import org.eclipse.tigerstripe.workbench.eclipse.wizards.artifacts.MethodDetailsDialog.ParameterRef;
	...
	private class AttributesListLabelProvider extends LabelProvider {
		...
		public String getText(Object element) {
			...
			return attributeRef.getName()
					...
					+ (attributeRef.getDimensions() == IType.MULTIPLICITY_MULTI? "[]"
							: "");
		}
	}
