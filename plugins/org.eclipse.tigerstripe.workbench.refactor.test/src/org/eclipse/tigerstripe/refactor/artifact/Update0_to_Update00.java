...
public class Update0_to_Update00 extends UITestCaseSWT {
	...
	public static void doChangeThroughDiagramInSamePackage(IUIContext ui)
		...
		IWidgetLocator tfl = helper.getNameEditLocator(ui, "Update0");
		ui.click(tfl);
		ui.click(tfl);
		Thread.sleep(1000);
		ui.click(tfl);
	...
	public static void internalCheckDiagram(IUIContext ui,
		...
		// Basic rename
		try {
			ui.click(helper.getUpdateProcedureLocator(ui, artifactPrefix
					+ "Update00"));
		} catch (Exception e) {
	...
	public static void doChangeThroughExplorer(IUIContext ui) throws Exception {
		...
		ui.contextClick(new TreeItemLocator(project + "/src/simple/Update0",
