...
public class Dependency0_to_Dependency00 extends UITestCaseSWT {
	...
	public static void internalCheckDiagram(IUIContext ui, LocatorHelper helper, String artifactPrefix){
		...
		// Basic rename
		try {
			ui.click(helper.getDependencyFigureLocator(ui, artifactPrefix+"Dependency00"));
		} catch (Exception e){
	...
	public static void doChangeThroughExplorer(IUIContext ui) throws Exception{
		...
		.contextClick(
				new TreeItemLocator(
						project+"/src/simple/Dependency0",
						view),
		"Refactor/Rename...");
	...
	public static void checkExplorerUpdates(IUIContext ui) throws Exception{
		...
		// Check for ourself!
		ArtifactHelper.checkArtifactInExplorer(ui, project, "simple", "Dependency00");
	...
	public static void checkAPI() throws Exception{
		...
		assertNull("Old artifact is still being returned from the Art Mgr", dependency0);
		
		IAbstractArtifact dependency00 = mgrSession
			.getArtifactByFullyQualifiedName("simple.Dependency00");
		assertNotNull("New artifact is still not being returned from the Art Mgr", dependency00);
// TODO - Replace These!		
