...
public class Event0_to_Event00 extends UITestCaseSWT {
	...
	public static void doChangeThroughDiagramInSamePackage(IUIContext ui)
		...
		IWidgetLocator tfl = helper.getNameEditLocator(ui, "Event0");
		ui.click(tfl);
		ui.click(tfl);
		Thread.sleep(1000);
		ui.click(tfl);
	...
	public static void internalCheckDiagram(IUIContext ui,
		...
		// Basic rename
		try {
			ui.click(helper.getNotificationLocator(ui, artifactPrefix
					+ "Event00"));
		} catch (Exception e) {
	...
	public static void checkExplorerUpdates(IUIContext ui) throws Exception {
		...
		// Check for ourself!
		ArtifactHelper
				.checkArtifactInExplorer(ui, project, "simple", "Event00");
