...
public class Session0_to_Session00 extends UITestCaseSWT {
	...
	public static void internalCheckDiagram(IUIContext ui,
		...
		// Basic rename
		try {
			ui.click(helper.getSessionFacadeLocator(ui, artifactPrefix
					+ "SessionFacade00"));
		} catch (Exception e) {
	...
	public static void openRelatedEditors(IUIContext ui) throws Exception {
		...
		ui.click(2, new TreeItemLocator(project + "/src/simple/SessionFacade0",
				view));
	...
	public static void doChangeThroughExplorer(IUIContext ui) throws Exception {
		...
		//ui.click(locator);
		ui.enterText("simple.SessionFacade00");
	...
	public static void checkAPI() throws Exception {
		...
		// Collection<IAbstractArtifact> entImplemented =
		// ent.getImplementedArtifacts();
		// assertTrue("Entity does not implement the new Artifact "+ent.getImplementedArtifactsAsStr(),
		// entImplemented.contains(sessionFacade00));
		// assertFalse("Entity still implements the new Artifact "+entImplemented,
		// entImplemented.contains(sessionFacade0));
