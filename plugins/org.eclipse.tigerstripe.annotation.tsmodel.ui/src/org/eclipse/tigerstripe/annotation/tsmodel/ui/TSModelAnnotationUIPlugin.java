 ...
 */
public class TSModelAnnotationUIPlugin extends AbstractUIPlugin {

	// The plug-in ID
	public static final String PLUGIN_ID = "org.eclipse.tigerstripe.annotation.tsmodel.ui";

	// The shared instance
	private static TSModelAnnotationUIPlugin plugin;
	
	/**
	 * The constructor
	 */
	public TSModelAnnotationUIPlugin() {
	}
	 ...
	 */
	public static TSModelAnnotationUIPlugin getDefault() {
		return plugin;
	}
