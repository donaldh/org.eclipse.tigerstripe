...
public class ListControl extends Composite {
	...
	private final class FilterEditor extends TreeEditor {
		...
		public void startEditing() {
			...
			text = (StringWrapper) ((IStructuredSelection) viewer.getSelection()).getFirstElement();
	...
	public ListControl(Composite parent, int style, boolean createButtons, List<StringWrapper> values) {
		...
		changeFilterItem.setText("Change");
		...
		if (createButtons) {
			...
			buttonsComposite.setLayoutData(new GridData(SWT.LEFT, SWT.TOP, false, true));
			...
			final Button changeFilterItemb = new Button(buttonsComposite, SWT.PUSH);
			changeFilterItemb.setText("Change");
			changeFilterItemb.addSelectionListener(new ChangeAdapter(filterEditor));
