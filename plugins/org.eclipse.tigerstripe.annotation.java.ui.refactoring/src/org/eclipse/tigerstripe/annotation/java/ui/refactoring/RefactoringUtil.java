...
//		}
	...
	public static IResource getResource(RefactoringDescriptor rrd) {
		...
		return getResource(project, input);
	}
	
	public static IPath getNewPath(IResource resource, RefactoringDescriptor rrd) {
		RefactoringContribution contr = RefactoringCore.getRefactoringContribution(rrd.getID());
		Map<?, ?> attrs = contr.retrieveArgumentMap(rrd);
