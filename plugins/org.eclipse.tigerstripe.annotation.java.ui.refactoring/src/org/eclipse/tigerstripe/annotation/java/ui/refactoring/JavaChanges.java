...
public class JavaChanges implements IElementChanges {
	...
	private static IJavaElement getJavaElement(Object element) {
		return (IJavaElement)Platform.getAdapterManager(
				).getAdapter(element, IJavaElement.class);
	}
	
	private static void collectChanges(IJavaElement element, JavaElementTree tree, Map<URI, URI> changes) {
            ...
            try {
	            ...
	            Arrays.sort(children, new Comparator<IJavaElement>() {
					...
					public int compare(IJavaElement o1, IJavaElement o2) {
						...
						if (uri1 == null && uri2 == null) return 0;
						if (uri1 == null) return -1;
						if (uri2 == null) return 1;
