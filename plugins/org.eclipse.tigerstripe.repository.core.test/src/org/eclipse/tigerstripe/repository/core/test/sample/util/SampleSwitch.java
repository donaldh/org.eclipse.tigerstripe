 ...
 * </copyright>
 *
 * $Id: SampleSwitch.java,v 1.1 2008/05/22 17:46:36 edillon Exp $
 */
...
public class SampleSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SamplePackage.TOP: {
				Top top = (Top)theEObject;
				T result = caseTop(top);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SamplePackage.VILLAGE: {
				Village village = (Village)theEObject;
				T result = caseVillage(village);
				if (result == null) result = caseTop(village);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SamplePackage.HOUSE: {
				House house = (House)theEObject;
				T result = caseHouse(house);
				if (result == null) result = caseTop(house);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SamplePackage.STREET: {
				Street street = (Street)theEObject;
				T result = caseStreet(street);
				if (result == null) result = caseTop(street);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SamplePackage.CAR: {
				Car car = (Car)theEObject;
				T result = caseCar(car);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SamplePackage.REGION: {
				Region region = (Region)theEObject;
				T result = caseRegion(region);
				if (result == null) result = caseTop(region);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SamplePackage.WINDOW: {
				Window window = (Window)theEObject;
				T result = caseWindow(window);
				if (result == null) result = caseTop(window);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Village</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Village</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseVillage(Village object) {
		return null;
	}
