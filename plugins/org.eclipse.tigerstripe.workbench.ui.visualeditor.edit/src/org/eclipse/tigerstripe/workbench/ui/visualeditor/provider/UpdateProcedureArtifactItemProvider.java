 ...
 * @generated
 */
public class UpdateProcedureArtifactItemProvider extends
	 ...
	 * @generated
	 */
	public UpdateProcedureArtifactItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns UpdateProcedureArtifact.gif. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @generated NOT
	 */
	...
	public String getText(Object object) {
		String label = ((UpdateProcedureArtifact) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_UpdateProcedureArtifact_type")
				: getString("_UI_UpdateProcedureArtifact_type") + " " + label;
	}
