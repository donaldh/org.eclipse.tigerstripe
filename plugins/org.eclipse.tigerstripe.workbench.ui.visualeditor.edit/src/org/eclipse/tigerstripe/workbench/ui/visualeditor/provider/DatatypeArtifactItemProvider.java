 ...
 * @generated
 */
public class DatatypeArtifactItemProvider extends AbstractArtifactItemProvider
	 ...
	 * @generated
	 */
	public DatatypeArtifactItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns DatatypeArtifact.gif. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @generated NOT
	 */
	...
	public Object getImage(Object object) {
		...
		if (icon == null) // this is necessary for the floating palette
			icon = Images.get(Images.DATATYPE_ICON);
	...
	public String getText(Object object) {
		String label = ((DatatypeArtifact) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_DatatypeArtifact_type")
				: getString("_UI_DatatypeArtifact_type") + " " + label;
	}
