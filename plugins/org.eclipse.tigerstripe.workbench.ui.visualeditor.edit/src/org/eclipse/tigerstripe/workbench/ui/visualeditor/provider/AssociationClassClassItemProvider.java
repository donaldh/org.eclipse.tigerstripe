 ...
 * @generated
 */
public class AssociationClassClassItemProvider extends
	 ...
	 * @generated
	 */
	public AssociationClassClassItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns AssociationClassClass.gif. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @generated NOT
	 */
	...
	public Object getImage(Object object) {
		...
		if (icon == null) // this is necessary for the floating palette
			icon = Images.get(Images.ASSOCIATIONCLASS_ICON);
	...
	public String getText(Object object) {
		String label = ((AssociationClassClass) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_AssociationClassClass_type")
				: getString("_UI_AssociationClassClass_type") + " " + label;
	}
