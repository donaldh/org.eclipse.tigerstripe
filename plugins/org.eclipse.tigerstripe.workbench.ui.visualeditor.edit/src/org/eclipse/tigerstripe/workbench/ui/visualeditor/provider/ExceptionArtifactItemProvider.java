 ...
 * @generated
 */
public class ExceptionArtifactItemProvider extends AbstractArtifactItemProvider
	 ...
	 * @generated
	 */
	public ExceptionArtifactItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns ExceptionArtifact.gif. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @generated NOT
	 */
	...
	public String getText(Object object) {
		String label = ((ExceptionArtifact) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_ExceptionArtifact_type")
				: getString("_UI_ExceptionArtifact_type") + " " + label;
	}
