 ...
 * @generated
 */
public class ManagedEntityArtifactItemProvider extends
	 ...
	 * @generated
	 */
	public ManagedEntityArtifactItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns ManagedEntityArtifact.gif. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @generated NOT
	 */
	...
	public Object getImage(Object object) {
		...
		if (icon == null) // this is necessary for the floating palette
			icon = Images.get(Images.ENTITY_ICON);
	...
	public String getText(Object object) {
		String label = ((ManagedEntityArtifact) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_ManagedEntityArtifact_type")
				: getString("_UI_ManagedEntityArtifact_type") + " " + label;
	}
