...
public class AssociationClassZEndNameEditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(TigerstripeVisualIDRegistry
				.getType(AssociationClassZEndNameEditPart.VISUAL_ID),
				new Point(-5, -15));
	}
	 ...
	 * @generated
	 */
	public AssociationClassZEndNameEditPart(View view) {
		super(view);
	}
	...
	protected String getLabelText() {
		...
		AssociationClass attr = (AssociationClass) node.getElement();
	...
	protected IFigure createFigurePrim() {
		return new AssociationClassZEndNameFigure();
	}

	/**
	 * @generated
	 */
	public class AssociationClassZEndNameFigure extends
			org.eclipse.gmf.runtime.draw2d.ui.figures.WrapLabel {

		/**
		 * @generated
		 */
		public AssociationClassZEndNameFigure() {

			this.setText("<...>");
			this.setFont(ASSOCIATIONCLASSZENDNAMEFIGURE_FONT);
			createContents();
		}
	 ...
	 * @generated NOT
	 */
	public static final org.eclipse.swt.graphics.Font ASSOCIATIONCLASSZENDNAMEFIGURE_FONT = new org.eclipse.swt.graphics.Font(
