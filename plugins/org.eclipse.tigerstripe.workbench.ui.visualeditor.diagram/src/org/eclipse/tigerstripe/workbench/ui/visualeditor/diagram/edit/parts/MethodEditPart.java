...
import org.eclipse.tigerstripe.workbench.ui.visualeditor.diagram.edit.policies.MethodItemSemanticEditPolicy;
 ...
 * @generated NOT
 */
public class MethodEditPart extends IconCachingCompartmentEditPart implements
		ITextAwareEditPart, TigerstripeMethodEditPart,
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new MethodItemSemanticEditPolicy());
			...
			ParserHintAdapter hintAdapter = new ParserHintAdapter(
				...
				public Object getAdapter(Class adapter) {
					if (IElementType.class.equals(adapter))
						return TigerstripeElementTypes.Method_2004;
	...
	protected void refreshFont() {
		...
		if (style != null) {
			FontData fontData = new FontData(style.getFontName(), style
					...
					| (isAbstract() ? SWT.ITALIC : SWT.NORMAL));
			setFont(fontData);
		} else {
	...
	protected void handleNotificationEvent(Notification event) {
		...
		if (VisualeditorPackage.eINSTANCE.getTypedElement_Visibility().equals(
			...
			refreshLabel();
		} else if (VisualeditorPackage.eINSTANCE.getNamedElement_Stereotypes()
				.equals(event.getFeature())) {
			refreshLabel();
		} else if (VisualeditorPackage.eINSTANCE.getMethod_IsAbstract().equals(
				event.getFeature())) {
			refreshFont();
			...
			if (parser instanceof ISemanticParser) {
				...
				if (modelParser.areSemanticElementsAffected(null, event)) {
					...
					&& ((EReferenceImpl) feature).getName()
							.equals("parameters")) {
				refreshVisuals();
			}
		}
	...
	protected IFigure createFigurePrim() {
		return new MethodLabelFigure();
	}

	/**
	 * @generated NOT
	 */
	public class MethodLabelFigure extends WrapLabel {

		/**
		 * @generated
		 */
		public MethodLabelFigure() {

			this.setText("<...>");
			this.setFont(METHODLABELFIGURE_FONT);
			createContents();
		}
	...
	protected boolean isAbstract() {
		...
		if (model.getElement() instanceof Method)
			return ((Method) model.getElement()).isIsAbstract();
		return false;
	}
	 ...
	 * @generated NOT
	 */
	public static final org.eclipse.swt.graphics.Font METHODLABELFIGURE_FONT = new org.eclipse.swt.graphics.Font(
