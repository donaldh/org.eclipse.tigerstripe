...
import org.eclipse.tigerstripe.workbench.ui.visualeditor.diagram.edit.policies.LiteralItemSemanticEditPolicy;
 ...
 * @generated NOT
 */
public class LiteralEditPart extends IconCachingCompartmentEditPart implements
		ITextAwareEditPart, TigerstripeLiteralEditPart,
	 ...
	 * @generated
	 */
	public LiteralEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new LiteralItemSemanticEditPolicy());
			...
			ParserHintAdapter hintAdapter = new ParserHintAdapter(
				...
				public Object getAdapter(Class adapter) {
					if (IElementType.class.equals(adapter))
						return TigerstripeElementTypes.Literal_2008;
	...
	protected IFigure createFigurePrim() {
		return new LiteralLabelFigure();
	}

	/**
	 * @generated NOT
	 */
	public class LiteralLabelFigure extends WrapLabel {

		/**
		 * @generated
		 */
		public LiteralLabelFigure() {

			this.setText("<...>");
			this.setFont(LITERALLABELFIGURE_FONT);
			createContents();
		}
	 ...
	 * @generated NOT
	 */
	public static final org.eclipse.swt.graphics.Font LITERALLABELFIGURE_FONT = new org.eclipse.swt.graphics.Font(
