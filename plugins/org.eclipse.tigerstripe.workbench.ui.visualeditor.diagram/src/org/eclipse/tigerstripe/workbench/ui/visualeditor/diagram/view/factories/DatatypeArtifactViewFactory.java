 ...
 * @generated NOT
 */
public class DatatypeArtifactViewFactory extends
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = TigerstripeVisualIDRegistry
					.getType(org.eclipse.tigerstripe.workbench.ui.visualeditor.diagram.edit.parts.DatatypeArtifactEditPart.VISUAL_ID);
		...
		getViewService()
				.createNode(
						...
						TigerstripeVisualIDRegistry
								.getType(DatatypeArtifactStereotypesEditPart.VISUAL_ID),
