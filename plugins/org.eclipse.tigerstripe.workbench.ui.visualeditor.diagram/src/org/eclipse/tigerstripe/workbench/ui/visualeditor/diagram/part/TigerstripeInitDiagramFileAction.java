 ...
 * @generated
 */
public class TigerstripeInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new TigerstripeNewDiagramFileWizard(
				mySelectedModelFile, myPart.getSite().getPage(), mySelection,
				diagramRoot, editingDomain);
		IDialogSettings pluginDialogSettings = TigerstripeDiagramEditorPlugin
