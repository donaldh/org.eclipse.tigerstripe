...
public class AssociationClassAEndNameEditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(TigerstripeVisualIDRegistry
				.getType(AssociationClassAEndNameEditPart.VISUAL_ID),
				new Point(0, -15));
	}
	 ...
	 * @generated
	 */
	public AssociationClassAEndNameEditPart(View view) {
		super(view);
	}
	...
	protected String getLabelText() {
		...
		if (NamedElementPropertiesHelper.ASSOC_SHOW_NAMEZEND
				.equals(detailsProp)
	...
	protected void handleNotificationEvent(Notification event) {
		...
		if (VisualeditorPackage.eINSTANCE.getAssociation_AEndVisibility()
				.equals(feature)) {
			refreshLabel();
	...
	protected IFigure createFigurePrim() {
		return new AssociationClassAEndNameFigure();
	}

	/**
	 * @generated
	 */
	public class AssociationClassAEndNameFigure extends
			org.eclipse.gmf.runtime.draw2d.ui.figures.WrapLabel {

		/**
		 * @generated
		 */
		public AssociationClassAEndNameFigure() {

			this.setText("<...>");
			this.setFont(ASSOCIATIONCLASSAENDNAMEFIGURE_FONT);
			createContents();
		}
	 ...
	 * @generated NOT
	 */
	public static final org.eclipse.swt.graphics.Font ASSOCIATIONCLASSAENDNAMEFIGURE_FONT = new org.eclipse.swt.graphics.Font(
