...
import org.eclipse.tigerstripe.workbench.ui.visualeditor.diagram.edit.commands.TigerstripeReorientConnectionViewCommand;

/**
 * @generated
 */
public class TigerstripeGraphicalNodeEditPolicy extends GraphicalNodeEditPolicy {
	...
	protected Command getConnectionWithReorientedViewCompleteCommand(
		...
		TransactionalEditingDomain editingDomain = ((IGraphicalEditPart) getHost())
				.getEditingDomain();
		TigerstripeReorientConnectionViewCommand rcvCommand = new TigerstripeReorientConnectionViewCommand(
				editingDomain, null);
