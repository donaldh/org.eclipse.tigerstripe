 ...
 * @generated NOT
 */
public class NotificationArtifactViewFactory extends
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = TigerstripeVisualIDRegistry
					.getType(org.eclipse.tigerstripe.workbench.ui.visualeditor.diagram.edit.parts.NotificationArtifactEditPart.VISUAL_ID);
		...
		getViewService()
				.createNode(
						...
						TigerstripeVisualIDRegistry
								.getType(NotificationArtifactStereotypesEditPart.VISUAL_ID),
