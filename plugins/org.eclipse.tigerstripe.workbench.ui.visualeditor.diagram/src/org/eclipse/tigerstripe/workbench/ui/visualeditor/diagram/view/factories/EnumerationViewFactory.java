 ...
 * @generated NOT
 */
public class EnumerationViewFactory extends AbstractTigerstripeShapeViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = TigerstripeVisualIDRegistry
					.getType(org.eclipse.tigerstripe.workbench.ui.visualeditor.diagram.edit.parts.EnumerationEditPart.VISUAL_ID);
		...
		getViewService().createNode(
				...
				TigerstripeVisualIDRegistry
						.getType(EnumerationStereotypesEditPart.VISUAL_ID),
		...
		getViewService().createNode(
				...
				view,
				TigerstripeVisualIDRegistry
						.getType(EnumerationBaseTypeEditPart.VISUAL_ID),
				ViewUtil.APPEND, true, getPreferencesHint());
		getViewService()
				.createNode(
						semanticAdapter,
