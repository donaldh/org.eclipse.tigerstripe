 ...
 * @generated
 */
public class TigerstripeDiagramEditorPlugin extends AbstractUIPlugin {

	/**
	 * @generated
	 */
	public static final String ID = "org.eclipse.tigerstripe.workbench.ui.visualeditor.diagram"; //$NON-NLS-1$
	 ...
	 * @generated
	 */
	private static TigerstripeDiagramEditorPlugin instance;
	 ...
	 * @generated
	 */
	public static TigerstripeDiagramEditorPlugin getInstance() {
		return instance;
	}
	...
	protected void fillItemProviderFactories(List factories) {
		factories.add(new VisualeditorItemProviderAdapterFactory());
	...
	public void logError(String error, Throwable throwable) {
		...
		getLog().log(
				new Status(IStatus.ERROR, TigerstripeDiagramEditorPlugin.ID,
	...
	public void logInfo(String message, Throwable throwable) {
		...
		getLog().log(
				new Status(IStatus.INFO, TigerstripeDiagramEditorPlugin.ID,
