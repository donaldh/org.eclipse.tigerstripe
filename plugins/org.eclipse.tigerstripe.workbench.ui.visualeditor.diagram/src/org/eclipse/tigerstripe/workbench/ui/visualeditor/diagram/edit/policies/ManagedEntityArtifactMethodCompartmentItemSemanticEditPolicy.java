 ...
 * @generated
 */
public class ManagedEntityArtifactMethodCompartmentItemSemanticEditPolicy
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (TigerstripeElementTypes.Method_2004 == req.getElementType()) {
			if (req.getContainmentFeature() == null) {
				req.setContainmentFeature(VisualeditorPackage.eINSTANCE
						.getAbstractArtifact_Methods());
			}
			return getMSLWrapper(new CreateMethod_2004Command(req));
		}
	 ...
	 * @generated NOT
	 */
	private static class CreateMethod_2004Command extends
			ConditionalCreateCommand {

		/**
		 * @generated
		 */
		public CreateMethod_2004Command(CreateElementRequest req) {
			super(req);
		}
