 ...
 * @generated
 */
public class SessionFacadeArtifactItemSemanticEditPolicy extends
	...
	protected Command getCreateRelationshipCommand(CreateRelationshipRequest req) {
		...
		if (TigerstripeElementTypes.SessionFacadeArtifactManagedEntities_3003 == req
				.getElementType())
			return req.getTarget() == null ? getCreateStartOutgoingSessionFacadeArtifact_ManagedEntities3003Command(req)
					: null;
		...
		if (TigerstripeElementTypes.SessionFacadeArtifactNamedQueries_3005 == req
				.getElementType())
			return req.getTarget() == null ? getCreateStartOutgoingSessionFacadeArtifact_NamedQueries3005Command(req)
					: null;
		if (TigerstripeElementTypes.SessionFacadeArtifactExposedProcedures_3006 == req
				.getElementType())
			return req.getTarget() == null ? getCreateStartOutgoingSessionFacadeArtifact_ExposedProcedures3006Command(req)
					: null;
	 ...
	 * @generated
	 */
	protected Command getCreateStartOutgoingSessionFacadeArtifact_EmittedNotifications3002Command(
			CreateRelationshipRequest req) {
	 ...
	 * @generated
	 */
	protected Command getCreateStartOutgoingSessionFacadeArtifact_ManagedEntities3003Command(
			CreateRelationshipRequest req) {
		if (!TigerstripeBaseItemSemanticEditPolicy.LinkConstraints.SessionFacadeArtifactManagedEntities_3003
				.canCreateLink(req, false))
			return UnexecutableCommand.INSTANCE;
	 ...
	 * @generated
	 */
	protected Command getCreateStartOutgoingSessionFacadeArtifact_NamedQueries3005Command(
			CreateRelationshipRequest req) {
	 ...
	 * @generated
	 */
	protected Command getCreateStartOutgoingSessionFacadeArtifact_ExposedProcedures3006Command(
			CreateRelationshipRequest req) {
		if (!TigerstripeBaseItemSemanticEditPolicy.LinkConstraints.SessionFacadeArtifactExposedProcedures_3006
				.canCreateLink(req, false))
			return UnexecutableCommand.INSTANCE;
