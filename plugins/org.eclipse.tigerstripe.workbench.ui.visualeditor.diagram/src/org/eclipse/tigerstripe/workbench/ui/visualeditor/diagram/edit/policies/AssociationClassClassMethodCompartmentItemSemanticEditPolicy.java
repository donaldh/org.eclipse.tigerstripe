 ...
 * @generated
 */
public class AssociationClassClassMethodCompartmentItemSemanticEditPolicy
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (TigerstripeElementTypes.Method_2012 == req.getElementType()) {
			if (req.getContainmentFeature() == null) {
				req.setContainmentFeature(VisualeditorPackage.eINSTANCE
						.getAbstractArtifact_Methods());
			}
			return getMSLWrapper(new CreateMethod_2012Command(req));
		}
	 ...
	 * @generated NOT
	 */
	private static class CreateMethod_2012Command extends CreateElementCommand {

		/**
		 * @generated
		 */
		public CreateMethod_2012Command(CreateElementRequest req) {
			super(req);
		}
		...
		protected EClass getEClassToEdit() {
			return VisualeditorPackage.eINSTANCE.getAssociationClassClass();
		};
