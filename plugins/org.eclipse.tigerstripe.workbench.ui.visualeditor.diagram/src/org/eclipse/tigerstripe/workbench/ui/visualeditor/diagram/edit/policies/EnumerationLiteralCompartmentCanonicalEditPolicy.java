 ...
 * @generated
 */
public class EnumerationLiteralCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		EObject nextValue;
		int nodeVID;
		for (Iterator values = ((AbstractArtifact) modelObject).getLiterals()
				.iterator(); values.hasNext();) {
			nextValue = (EObject) values.next();
			nodeVID = TigerstripeVisualIDRegistry.getNodeVisualID(viewObject,
					nextValue);
			if (LiteralEditPart.VISUAL_ID == nodeVID) {
