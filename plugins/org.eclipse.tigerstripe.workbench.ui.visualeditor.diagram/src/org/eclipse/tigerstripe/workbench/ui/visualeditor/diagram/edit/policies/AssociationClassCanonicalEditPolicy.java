 ...
 * @generated NOT
 */
public class AssociationClassCanonicalEditPolicy extends
	...
	public void activate() {
		associationClass = (AssociationClass) ((AssociationClassEditPart) getHost())
	...
	protected EObject getTargetElement(EObject relationship) {
		...
		// element
		// is attached to.
		return associationClass.getZEnd();
	}
	...
	protected EObject getSourceElement(EObject relationship) {
		...
		// element
		// is attached to.
		return associationClass.getAEnd();
	}
