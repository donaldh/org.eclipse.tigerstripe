 ...
 * @generated
 */
public class UpdateProcedureArtifactItemSemanticEditPolicy extends
	...
	protected Command getCreateRelationshipCommand(CreateRelationshipRequest req) {
		...
		if (TigerstripeElementTypes.SessionFacadeArtifactExposedProcedures_3006 == req
				.getElementType())
			return req.getTarget() == null ? null
					: getCreateCompleteIncomingSessionFacadeArtifact_ExposedProcedures3006Command(req);
	 ...
	 * @generated
	 */
	protected Command getCreateCompleteIncomingSessionFacadeArtifact_ExposedProcedures3006Command(
			CreateRelationshipRequest req) {
		if (!(req.getSource() instanceof SessionFacadeArtifact))
			return UnexecutableCommand.INSTANCE;
		SessionFacadeArtifact element = (SessionFacadeArtifact) req.getSource();
		if (element.getExposedProcedures().contains(req.getTarget()))
			return UnexecutableCommand.INSTANCE;
		...
		SetRequest setReq = new SetRequest(req.getSource(),
				VisualeditorPackage.eINSTANCE
						.getSessionFacadeArtifact_ExposedProcedures(), req
						.getTarget());
		return getMSLWrapper(new SetValueCommand(setReq));
	}
