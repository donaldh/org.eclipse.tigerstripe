...
public class ManagedEntityArtifactEditPart extends TigerstripeShapeNodeEditPart
	 ...
	 * @generated
	 */
	public ManagedEntityArtifactEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
					...
					public Command getCommand(Request request) {
						if (understandsRequest(request)) {
							if (request instanceof CreateViewAndElementRequest) {
								...
								if (type == TigerstripeElementTypes.Attribute_2003) {
								...
								if (type == TigerstripeElementTypes.Method_2004) {
									EditPart compartmentEditPart = getChildBySemanticHint(TigerstripeVisualIDRegistry
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ManagedEntityArtifactItemSemanticEditPolicy());
		installEditPolicy(EditPolicy.GRAPHICAL_NODE_ROLE,
				new ManagedEntityArtifactGraphicalNodeEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new ManagedEntityArtifactCanonicalEditPolicy());
	...
	protected IFigure createNodeShape() {
		ManagedEntityArtifactFigure figure = new ManagedEntityArtifactFigure();
	 ...
	 * @generated
	 */
	public ManagedEntityArtifactFigure getPrimaryShape() {
		return (ManagedEntityArtifactFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ManagedEntityArtifactStereotypesEditPart) {
			((ManagedEntityArtifactStereotypesEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureManagedEntityStereotypesFigure());
			return true;
		}
		if (childEditPart instanceof ManagedEntityArtifactNamePackageEditPart) {
			((ManagedEntityArtifactNamePackageEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureManagedEntityNameFigure());
			return true;
		}
		return false;
	}
	 ...
	 * @generated NOT
	 */
	public class ManagedEntityArtifactFigure extends
			org.eclipse.draw2d.RectangleFigure {

		/**
		 * @generated NOT
		 */
		public ManagedEntityArtifactFigure() {
			createContents();
		}
		...
		private void createContents() {
			...
			setFigureManagedEntityNameFigure(fig_1);
		 ...
		 * @generated NOT
		 */
		private WrapLabel fManagedEntityNameFigure;

		/**
		 * @generated NOT
		 */
		public WrapLabel getFigureManagedEntityNameFigure() {
			return fManagedEntityNameFigure;
		}

		/**
		 * @generated NOT
		 */
		private void setFigureManagedEntityNameFigure(WrapLabel fig) {
			fManagedEntityNameFigure = fig;
		}

		/**
		 * @generated
		 */
		private org.eclipse.gmf.runtime.draw2d.ui.figures.WrapLabel fManagedEntityStereotypesFigure;

		/**
		 * @generated
		 */
		public org.eclipse.gmf.runtime.draw2d.ui.figures.WrapLabel getFigureManagedEntityStereotypesFigure() {
			return fManagedEntityStereotypesFigure;
		}

		/**
		 * @generated
		 */
		private void setFigureManagedEntityStereotypesFigure(
				org.eclipse.gmf.runtime.draw2d.ui.figures.WrapLabel fig) {
			fManagedEntityStereotypesFigure = fig;
		}
	 ...
	 * @generated
	 */
	public static final org.eclipse.swt.graphics.Color MANAGEDENTITYARTIFACTFIGURE_BACK = new org.eclipse.swt.graphics.Color(
			null, 250, 245, 210);
