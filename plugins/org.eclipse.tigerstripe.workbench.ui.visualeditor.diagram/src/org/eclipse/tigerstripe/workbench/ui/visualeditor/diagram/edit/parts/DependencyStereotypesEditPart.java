 ...
 * @generated NOT
 */
public class DependencyStereotypesEditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(TigerstripeVisualIDRegistry
				.getType(DependencyStereotypesEditPart.VISUAL_ID), new Point(0,
				-30));
	}
	 ...
	 * @generated
	 */
	public DependencyStereotypesEditPart(View view) {
		super(view);
	}
		...
		if (NotationPackage.eINSTANCE.getFontStyle_FontColor().equals(feature)) {
			...
			if (getParser() != null
					&& getParser().isAffectingEvent(event,
							getParserOptions().intValue())) {
				DependencyEditPart depEditPart = (DependencyEditPart) this
						.getParent();
				for (Object part : depEditPart.getChildren()) {
					if (part instanceof DependencyNamePackageEditPart) {
						DependencyNamePackageEditPart namePackageEditPart = (DependencyNamePackageEditPart) part;
	...
	protected IFigure createFigurePrim() {
		return new DependencyStereotypesFigure();
	}

	/**
	 * @generated
	 */
	public class DependencyStereotypesFigure extends
...
//			this.setFont(DEPENDENCYSTEREOTYPESFIGURE_FONT);
	 ...
	 * @generated
	 */
	public static final org.eclipse.swt.graphics.Font DEPENDENCYSTEREOTYPESFIGURE_FONT = new org.eclipse.swt.graphics.Font(
