 ...
 * @generated
 */
public class SessionFacadeArtifactExposedProceduresViewFactory extends
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = TigerstripeVisualIDRegistry
					.getType(org.eclipse.tigerstripe.workbench.ui.visualeditor.diagram.edit.parts.SessionFacadeArtifactExposedProceduresEditPart.VISUAL_ID);
		...
		getViewService().createNode(
				...
				TigerstripeVisualIDRegistry
						.getType(SessionExposesEditPart.VISUAL_ID),
