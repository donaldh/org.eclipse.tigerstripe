 ...
 * @generated
 */
public class QueryReturnsEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(TigerstripeVisualIDRegistry
				.getType(QueryReturnsEditPart.VISUAL_ID), new Point(0, -15));
	}

	/**
	 * @generated
	 */
	public QueryReturnsEditPart(View view) {
		super(view);
	}
			...
			ParserHintAdapter hintAdapter = new ParserHintAdapter(
				...
				public Object getAdapter(Class adapter) {
					if (IElementType.class.equals(adapter))
						return TigerstripeElementTypes.NamedQueryArtifactReturnedType_3004;
	...
	protected IFigure createFigurePrim() {
		return new QueryReturnsFigure();
	}

	/**
	 * @generated
	 */
	public class QueryReturnsFigure extends
			org.eclipse.gmf.runtime.draw2d.ui.figures.WrapLabel {

		/**
		 * @generated
		 */
		public QueryReturnsFigure() {

			this.setText("<<returns>>");
			this.setFont(QUERYRETURNSFIGURE_FONT);
			createContents();
		}
	 ...
	 * @generated
	 */
	public static final org.eclipse.swt.graphics.Font QUERYRETURNSFIGURE_FONT = new org.eclipse.swt.graphics.Font(
