 ...
 * @generated
 */
public class SessionManagesEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(TigerstripeVisualIDRegistry
				.getType(SessionManagesEditPart.VISUAL_ID), new Point(0, -15));
	}

	/**
	 * @generated
	 */
	public SessionManagesEditPart(View view) {
		super(view);
	}
			...
			ParserHintAdapter hintAdapter = new ParserHintAdapter(
				...
				public Object getAdapter(Class adapter) {
					if (IElementType.class.equals(adapter))
						return TigerstripeElementTypes.SessionFacadeArtifactManagedEntities_3003;
	...
	protected IFigure createFigurePrim() {
		return new SessionManagesFigure();
	}

	/**
	 * @generated
	 */
	public class SessionManagesFigure extends
			org.eclipse.gmf.runtime.draw2d.ui.figures.WrapLabel {

		/**
		 * @generated
		 */
		public SessionManagesFigure() {

			this.setText("<<manages>>");
			this.setFont(SESSIONMANAGESFIGURE_FONT);
			createContents();
		}
	 ...
	 * @generated
	 */
	public static final org.eclipse.swt.graphics.Font SESSIONMANAGESFIGURE_FONT = new org.eclipse.swt.graphics.Font(
