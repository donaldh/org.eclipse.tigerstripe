 ...
 * @generated
 */
public class SessionSupportsEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(TigerstripeVisualIDRegistry
				.getType(SessionSupportsEditPart.VISUAL_ID), new Point(0, -15));
	}

	/**
	 * @generated
	 */
	public SessionSupportsEditPart(View view) {
		super(view);
	}
			...
			ParserHintAdapter hintAdapter = new ParserHintAdapter(
				...
				public Object getAdapter(Class adapter) {
					if (IElementType.class.equals(adapter))
						return TigerstripeElementTypes.SessionFacadeArtifactNamedQueries_3005;
	...
	protected IFigure createFigurePrim() {
		return new SessionSupportsFigure();
	}

	/**
	 * @generated
	 */
	public class SessionSupportsFigure extends
			org.eclipse.gmf.runtime.draw2d.ui.figures.WrapLabel {

		/**
		 * @generated
		 */
		public SessionSupportsFigure() {

			this.setText("<<supports>>");
			this.setFont(SESSIONSUPPORTSFIGURE_FONT);
			createContents();
		}
	 ...
	 * @generated
	 */
	public static final org.eclipse.swt.graphics.Font SESSIONSUPPORTSFIGURE_FONT = new org.eclipse.swt.graphics.Font(
