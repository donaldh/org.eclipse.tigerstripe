 ...
 * @generated
 */
public class NamedQueryArtifactReturnedTypeViewFactory extends
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = TigerstripeVisualIDRegistry
					.getType(org.eclipse.tigerstripe.workbench.ui.visualeditor.diagram.edit.parts.NamedQueryArtifactReturnedTypeEditPart.VISUAL_ID);
		...
		getViewService().createNode(
				...
				TigerstripeVisualIDRegistry
						.getType(QueryReturnsEditPart.VISUAL_ID),
