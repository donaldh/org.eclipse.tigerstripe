 ...
 * @generated
 */
public class ManagedEntityArtifactAttributeCompartmentItemSemanticEditPolicy
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (TigerstripeElementTypes.Attribute_2003 == req.getElementType()) {
			if (req.getContainmentFeature() == null) {
				req.setContainmentFeature(VisualeditorPackage.eINSTANCE
						.getAbstractArtifact_Attributes());
			}
			return getMSLWrapper(new CreateAttribute_2003Command(req));
		}
	 ...
	 * @generated NOT
	 */
	private static class CreateAttribute_2003Command extends
			ConditionalCreateCommand {

		/**
		 * @generated
		 */
		public CreateAttribute_2003Command(CreateElementRequest req) {
			super(req);
		}
		...
		protected EClass getEClassToEdit() {
			return VisualeditorPackage.eINSTANCE.getManagedEntityArtifact();
		};
