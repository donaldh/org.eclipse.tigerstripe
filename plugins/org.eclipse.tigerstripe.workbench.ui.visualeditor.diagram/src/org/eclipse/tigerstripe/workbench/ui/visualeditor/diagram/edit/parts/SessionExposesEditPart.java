 ...
 * @generated
 */
public class SessionExposesEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(TigerstripeVisualIDRegistry
				.getType(SessionExposesEditPart.VISUAL_ID), new Point(0, -15));
	}

	/**
	 * @generated
	 */
	public SessionExposesEditPart(View view) {
		super(view);
	}
			...
			ParserHintAdapter hintAdapter = new ParserHintAdapter(
				...
				public Object getAdapter(Class adapter) {
					if (IElementType.class.equals(adapter))
						return TigerstripeElementTypes.SessionFacadeArtifactExposedProcedures_3006;
	...
	protected IFigure createFigurePrim() {
		return new SessionExposesFigure();
	}

	/**
	 * @generated
	 */
	public class SessionExposesFigure extends
			org.eclipse.gmf.runtime.draw2d.ui.figures.WrapLabel {

		/**
		 * @generated
		 */
		public SessionExposesFigure() {

			this.setText("<<exposes>>");
			this.setFont(SESSIONEXPOSESFIGURE_FONT);
			createContents();
		}
	 ...
	 * @generated
	 */
	public static final org.eclipse.swt.graphics.Font SESSIONEXPOSESFIGURE_FONT = new org.eclipse.swt.graphics.Font(
