 ...
 * @generated
 */
public class ExceptionArtifactAttributeCompartmentItemSemanticEditPolicy extends
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (TigerstripeElementTypes.Attribute_2002 == req.getElementType()) {
			if (req.getContainmentFeature() == null) {
				req.setContainmentFeature(VisualeditorPackage.eINSTANCE
						.getAbstractArtifact_Attributes());
			}
			return getMSLWrapper(new CreateAttribute_2002Command(req));
		}
	 ...
	 * @generated NOT
	 */
	private static class CreateAttribute_2002Command extends
			ConditionalCreateCommand {

		/**
		 * @generated
		 */
		public CreateAttribute_2002Command(CreateElementRequest req) {
			super(req);
		}
		...
		protected EClass getEClassToEdit() {
			return VisualeditorPackage.eINSTANCE.getExceptionArtifact();
		};
