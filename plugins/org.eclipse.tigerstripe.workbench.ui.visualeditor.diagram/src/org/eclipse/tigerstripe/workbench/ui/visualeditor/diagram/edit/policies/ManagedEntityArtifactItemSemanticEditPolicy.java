 ...
 * @generated
 */
public class ManagedEntityArtifactItemSemanticEditPolicy extends
	...
	protected Command getCreateRelationshipCommand(CreateRelationshipRequest req) {
		...
		if (TigerstripeElementTypes.SessionFacadeArtifactManagedEntities_3003 == req
			...
			return req.getTarget() == null ? null
					: getCreateCompleteIncomingSessionFacadeArtifact_ManagedEntities3003Command(req);
		...
		if (TigerstripeElementTypes.AbstractArtifactImplements_3012 == req.getElementType())
	 ...
	 * @generated
	 */
	protected Command getCreateCompleteIncomingSessionFacadeArtifact_ManagedEntities3003Command(
			CreateRelationshipRequest req) {
		if (!(req.getSource() instanceof SessionFacadeArtifact))
			return UnexecutableCommand.INSTANCE;
		SessionFacadeArtifact element = (SessionFacadeArtifact) req.getSource();
		if (element.getManagedEntities().contains(req.getTarget()))
			return UnexecutableCommand.INSTANCE;
		...
		SetRequest setReq = new SetRequest(req.getSource(),
				VisualeditorPackage.eINSTANCE
						.getSessionFacadeArtifact_ManagedEntities(), req
						.getTarget());
	...
	//========================
	// Everything from here down is NOT generated, but is based on stuff that was generated!
	//========================
