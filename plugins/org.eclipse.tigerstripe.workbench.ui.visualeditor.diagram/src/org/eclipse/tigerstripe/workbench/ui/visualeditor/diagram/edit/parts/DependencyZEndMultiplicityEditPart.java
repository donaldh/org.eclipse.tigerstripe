 ...
 * @generated
 */
public class DependencyZEndMultiplicityEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(TigerstripeVisualIDRegistry
				.getType(DependencyZEndMultiplicityEditPart.VISUAL_ID),
				new Point(-5, 15));
	}
	 ...
	 * @generated
	 */
	public DependencyZEndMultiplicityEditPart(View view) {
		super(view);
	}
