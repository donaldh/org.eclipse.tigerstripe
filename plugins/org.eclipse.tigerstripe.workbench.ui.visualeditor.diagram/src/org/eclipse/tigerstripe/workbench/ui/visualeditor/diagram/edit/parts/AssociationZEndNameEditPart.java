 ...
 * @generated
 */
public class AssociationZEndNameEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(TigerstripeVisualIDRegistry
				.getType(AssociationZEndNameEditPart.VISUAL_ID), new Point(-5,
				-15));
	}
	 ...
	 * @generated
	 */
	public AssociationZEndNameEditPart(View view) {
		super(view);
	}
	...
	protected String getLabelText() {
		...
		Association attr = (Association) node.getElement();
		...
		if (NamedElementPropertiesHelper.ASSOC_SHOW_AENDNAME
				.equals(detailsProp)
	...
	protected void handleNotificationEvent(Notification event) {
		...
		if (VisualeditorPackage.eINSTANCE.getAssociation_ZEndVisibility()
				.equals(feature)) {
			refreshLabel();
	...
	protected IFigure createFigurePrim() {
		return new AssociationZEndNameFigure();
	}

	/**
	 * @generated
	 */
	public class AssociationZEndNameFigure extends
			org.eclipse.gmf.runtime.draw2d.ui.figures.WrapLabel {

		/**
		 * @generated
		 */
		public AssociationZEndNameFigure() {

			this.setText("<...>");
			this.setFont(ASSOCIATIONZENDNAMEFIGURE_FONT);
			createContents();
		}
	 ...
	 * @generated NOT
	 */
	public static final org.eclipse.swt.graphics.Font ASSOCIATIONZENDNAMEFIGURE_FONT = new org.eclipse.swt.graphics.Font(
