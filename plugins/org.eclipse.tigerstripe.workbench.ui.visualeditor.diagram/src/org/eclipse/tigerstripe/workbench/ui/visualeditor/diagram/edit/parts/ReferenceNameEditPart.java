...
public class ReferenceNameEditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(TigerstripeVisualIDRegistry
				.getType(ReferenceNameEditPart.VISUAL_ID), new Point(0, -15));
	}
	...
	protected IFigure createFigurePrim() {
		return new ReferenceNameFigure();
	}

	/**
	 * @generated
	 */
	public class ReferenceNameFigure extends
		...
		public ReferenceNameFigure() {
			...
			this.setText("<...>");
			this.setFont(REFERENCENAMEFIGURE_FONT);
			createContents();
		}
	 ...
	 * @generated
	 */
	public static final org.eclipse.swt.graphics.Font REFERENCENAMEFIGURE_FONT = new org.eclipse.swt.graphics.Font(
