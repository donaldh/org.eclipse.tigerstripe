 ...
 * @generated NOT
 */
public class NamedQueryArtifactStereotypesEditPart extends CompartmentEditPart
		implements ITextAwareEditPart, TigerstripeStereotypeEditPart {
	 ...
	 * @generated
	 */
	public NamedQueryArtifactStereotypesEditPart(View view) {
		super(view);
	}
	...
	protected String getLabelText() {
		...
		// No use of default text so we can hide stereotypes properly.
			...
			ParserHintAdapter hintAdapter = new ParserHintAdapter(
				...
				public Object getAdapter(Class adapter) {
					if (IElementType.class.equals(adapter))
						return TigerstripeElementTypes.NamedQueryArtifact_1001;
