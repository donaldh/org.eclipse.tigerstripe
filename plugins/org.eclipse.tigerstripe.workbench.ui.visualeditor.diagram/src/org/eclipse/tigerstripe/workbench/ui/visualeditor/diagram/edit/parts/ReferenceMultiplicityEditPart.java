 ...
 * @generated
 */
public class ReferenceMultiplicityEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(TigerstripeVisualIDRegistry
				.getType(ReferenceMultiplicityEditPart.VISUAL_ID), new Point(
				-5, 15));
	}
	 ...
	 * @generated
	 */
	public ReferenceMultiplicityEditPart(View view) {
		super(view);
	}
			...
			ParserHintAdapter hintAdapter = new ParserHintAdapter(
				...
				public Object getAdapter(Class adapter) {
					if (IElementType.class.equals(adapter))
						return TigerstripeElementTypes.Reference_3009;
	...
	protected IFigure createFigurePrim() {
		return new ReferenceZEndMultiplicityFigure();
	}

	/**
	 * @generated
	 */
	public class ReferenceZEndMultiplicityFigure extends
			org.eclipse.gmf.runtime.draw2d.ui.figures.WrapLabel {

		/**
		 * @generated
		 */
		public ReferenceZEndMultiplicityFigure() {

			this.setText("1");
			this.setFont(REFERENCEZENDMULTIPLICITYFIGURE_FONT);
			createContents();
		}
	 ...
	 * @generated
	 */
	public static final org.eclipse.swt.graphics.Font REFERENCEZENDMULTIPLICITYFIGURE_FONT = new org.eclipse.swt.graphics.Font(
