 ...
 * @generated NOT
 */
public class AssociationStereotypesEditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(TigerstripeVisualIDRegistry
				.getType(AssociationStereotypesEditPart.VISUAL_ID), new Point(
				0, -30));
	}
	 ...
	 * @generated
	 */
	public AssociationStereotypesEditPart(View view) {
		super(view);
	}
		...
		if (NotationPackage.eINSTANCE.getFontStyle_FontColor().equals(feature)) {
			...
			if (getParser() != null
					&& getParser().isAffectingEvent(event,
							getParserOptions().intValue())) {
				AssociationEditPart assocEditPart = (AssociationEditPart) this
						.getParent();
				for (Object part : assocEditPart.getChildren()) {
					if (part instanceof AssociationNamePackageEditPart) {
						AssociationNamePackageEditPart namePackageEditPart = (AssociationNamePackageEditPart) part;
						namePackageEditPart.refreshLabel();
						break;
					}
				}
			}
	...
	protected IFigure createFigurePrim() {
		return new AssociationStereotypesFigure();
	}

	/**
	 * @generated
	 */
	public class AssociationStereotypesFigure extends
...
//			this.setFont(ASSOCIATIONSTEREOTYPESFIGURE_FONT);
	 ...
	 * @generated
	 */
	public static final org.eclipse.swt.graphics.Font ASSOCIATIONSTEREOTYPESFIGURE_FONT = new org.eclipse.swt.graphics.Font(
