 ...
 * @generated
 */
public class NamedQueryArtifactAttributeCompartmentItemSemanticEditPolicy
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (TigerstripeElementTypes.Attribute_2001 == req.getElementType()) {
			if (req.getContainmentFeature() == null) {
				req.setContainmentFeature(VisualeditorPackage.eINSTANCE
						.getAbstractArtifact_Attributes());
			}
			return getMSLWrapper(new CreateAttribute_2001Command(req));
		}
	 ...
	 * @generated NOT
	 */
	private static class CreateAttribute_2001Command extends
			ConditionalCreateCommand {

		/**
		 * @generated
		 */
		public CreateAttribute_2001Command(CreateElementRequest req) {
			super(req);
		}
		...
		protected EClass getEClassToEdit() {
			return VisualeditorPackage.eINSTANCE.getNamedQueryArtifact();
		};
