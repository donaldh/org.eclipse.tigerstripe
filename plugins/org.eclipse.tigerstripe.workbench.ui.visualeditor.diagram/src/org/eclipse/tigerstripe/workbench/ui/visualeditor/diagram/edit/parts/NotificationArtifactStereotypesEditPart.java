 ...
 * @generated NOT
 */
public class NotificationArtifactStereotypesEditPart extends
	 ...
	 * @generated
	 */
	public NotificationArtifactStereotypesEditPart(View view) {
		super(view);
	}
			...
			ParserHintAdapter hintAdapter = new ParserHintAdapter(
				...
				public Object getAdapter(Class adapter) {
					if (IElementType.class.equals(adapter))
						return TigerstripeElementTypes.NotificationArtifact_1004;
