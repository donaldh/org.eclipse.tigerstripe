 ...
 * @generated
 */
public class ReferenceViewFactory extends TigerstripeConnectionViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = TigerstripeVisualIDRegistry
					.getType(org.eclipse.tigerstripe.workbench.ui.visualeditor.diagram.edit.parts.ReferenceEditPart.VISUAL_ID);
		...
		getViewService().createNode(
				...
				view,
				TigerstripeVisualIDRegistry
						.getType(ReferenceMultiplicityEditPart.VISUAL_ID),
				ViewUtil.APPEND, true, getPreferencesHint());
	}
