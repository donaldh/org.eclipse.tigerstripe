 ...
 * @generated
 */
public class NotificationArtifactAttributeCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		EObject nextValue;
		int nodeVID;
		for (Iterator values = ((AbstractArtifact) modelObject).getAttributes()
				.iterator(); values.hasNext();) {
			nextValue = (EObject) values.next();
			nodeVID = TigerstripeVisualIDRegistry.getNodeVisualID(viewObject,
					nextValue);
			if (Attribute4EditPart.VISUAL_ID == nodeVID) {
