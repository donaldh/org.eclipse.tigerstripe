 ...
 * @generated
 */
public class UpdateProcedureArtifactAttributeCompartmentItemSemanticEditPolicy
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (TigerstripeElementTypes.Attribute_2009 == req.getElementType()) {
			if (req.getContainmentFeature() == null) {
				req.setContainmentFeature(VisualeditorPackage.eINSTANCE
						.getAbstractArtifact_Attributes());
			}
			return getMSLWrapper(new CreateAttribute_2009Command(req));
		}
	 ...
	 * @generated NOT
	 */
	private static class CreateAttribute_2009Command extends
			ConditionalCreateCommand {

		/**
		 * @generated
		 */
		public CreateAttribute_2009Command(CreateElementRequest req) {
			super(req);
		}
		...
		protected EClass getEClassToEdit() {
			return VisualeditorPackage.eINSTANCE.getUpdateProcedureArtifact();
		};
