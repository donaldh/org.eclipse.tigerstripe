 ...
 * @generated
 */
public class DatatypeArtifactMethodCompartmentItemSemanticEditPolicy extends
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (TigerstripeElementTypes.Method_2007 == req.getElementType()) {
			if (req.getContainmentFeature() == null) {
				req.setContainmentFeature(VisualeditorPackage.eINSTANCE
						.getAbstractArtifact_Methods());
			}
			return getMSLWrapper(new CreateMethod_2007Command(req));
		}
	 ...
	 * @generated NOT
	 */
	private static class CreateMethod_2007Command extends
			ConditionalCreateCommand {

		/**
		 * @generated
		 */
		public CreateMethod_2007Command(CreateElementRequest req) {
			super(req);
		}
