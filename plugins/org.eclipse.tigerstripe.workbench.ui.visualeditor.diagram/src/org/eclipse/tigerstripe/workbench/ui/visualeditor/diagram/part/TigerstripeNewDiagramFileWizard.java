 ...
 * @generated
 */
public class TigerstripeNewDiagramFileWizard extends Wizard {
	 ...
	 * @generated
	 */
	public TigerstripeNewDiagramFileWizard(IFile selectedModelFile,
			IWorkbenchPage workbenchPage, IStructuredSelection selection,
			EObject diagramRoot, TransactionalEditingDomain editingDomain) {
		assert selectedModelFile != null : "Null selectedModelFile in TigerstripeNewDiagramFileWizard constructor"; //$NON-NLS-1$
		assert workbenchPage != null : "Null workbenchPage in TigerstripeNewDiagramFileWizard constructor"; //$NON-NLS-1$
		assert selection != null : "Null selection in TigerstripeNewDiagramFileWizard constructor"; //$NON-NLS-1$
		assert diagramRoot != null : "Null diagramRoot in TigerstripeNewDiagramFileWizard constructor"; //$NON-NLS-1$
		assert editingDomain != null : "Null editingDomain in TigerstripeNewDiagramFileWizard constructor"; //$NON-NLS-1$
		...
		myFileCreationPage = new WizardNewFileCreationPage(
			...
			public void createControl(Composite parent) {
				...
				String originalFileName = mySelectedModelFile
						...
						.lastSegment();
				String fileExtension = ".wvd"; //$NON-NLS-1$
	...
	public boolean performFinish() {
		...
		AbstractTransactionalCommand command = new AbstractTransactionalCommand(
			...
			protected CommandResult doExecuteWithResult(
				...
				int diagramVID = TigerstripeVisualIDRegistry
