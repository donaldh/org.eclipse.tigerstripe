 ...
 * @generated
 */
public class AssociationClassClassAttributeCompartmentItemSemanticEditPolicy
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (TigerstripeElementTypes.Attribute_2011 == req.getElementType()) {
			if (req.getContainmentFeature() == null) {
				req.setContainmentFeature(VisualeditorPackage.eINSTANCE
						.getAbstractArtifact_Attributes());
			}
			return getMSLWrapper(new CreateAttribute_2011Command(req));
		}
	 ...
	 * @generated NOT
	 */
	private static class CreateAttribute_2011Command extends
			ConditionalCreateCommand {

		/**
		 * @generated
		 */
		public CreateAttribute_2011Command(CreateElementRequest req) {
			super(req);
		}
