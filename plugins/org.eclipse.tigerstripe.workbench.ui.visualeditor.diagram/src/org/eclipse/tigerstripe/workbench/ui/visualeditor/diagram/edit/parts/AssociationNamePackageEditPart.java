...
public class AssociationNamePackageEditPart extends
	...
	static {
		registerSnapBackPosition(TigerstripeVisualIDRegistry
				.getType(AssociationNamePackageEditPart.VISUAL_ID), new Point(
				0, -15));
	}
	 ...
	 * @generated
	 */
	public AssociationNamePackageEditPart(View view) {
		super(view);
	}
	...
	protected String getLabelText() {
		...
		// Check if a local property is set to hide/show the association name
		NamedElementPropertiesHelper neHelper = new NamedElementPropertiesHelper(
				qualNamedElem);
		String detailsProp = neHelper
	...
	protected IFigure createFigurePrim() {
		figure = new AssociationNameFigure();
		return figure;
	}
	 ...
	 * @generated
	 */
	public class AssociationNameFigure extends
			org.eclipse.gmf.runtime.draw2d.ui.figures.WrapLabel {

		/**
		 * @generated
		 */
		public AssociationNameFigure() {

			this.setText("<...>");
			this.setFont(ASSOCIATIONNAMEFIGURE_FONT);
	 ...
	 * @generated
	 */
	public static final org.eclipse.swt.graphics.Font ASSOCIATIONNAMEFIGURE_FONT = new org.eclipse.swt.graphics.Font(
