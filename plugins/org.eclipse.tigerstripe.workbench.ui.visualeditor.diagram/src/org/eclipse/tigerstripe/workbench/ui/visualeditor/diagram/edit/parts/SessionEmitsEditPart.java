 ...
 * @generated
 */
public class SessionEmitsEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(TigerstripeVisualIDRegistry
				.getType(SessionEmitsEditPart.VISUAL_ID), new Point(0, -15));
	}

	/**
	 * @generated
	 */
	public SessionEmitsEditPart(View view) {
		super(view);
	}
			...
			ParserHintAdapter hintAdapter = new ParserHintAdapter(
				...
				public Object getAdapter(Class adapter) {
					if (IElementType.class.equals(adapter))
						return TigerstripeElementTypes.SessionFacadeArtifactEmittedNotifications_3002;
	...
	protected IFigure createFigurePrim() {
		return new SessionEmitsFigure();
	}

	/**
	 * @generated
	 */
	public class SessionEmitsFigure extends
			org.eclipse.gmf.runtime.draw2d.ui.figures.WrapLabel {

		/**
		 * @generated
		 */
		public SessionEmitsFigure() {

			this.setText("<<emits>>");
			this.setFont(SESSIONEMITSFIGURE_FONT);
			createContents();
		}
	 ...
	 * @generated
	 */
	public static final org.eclipse.swt.graphics.Font SESSIONEMITSFIGURE_FONT = new org.eclipse.swt.graphics.Font(
