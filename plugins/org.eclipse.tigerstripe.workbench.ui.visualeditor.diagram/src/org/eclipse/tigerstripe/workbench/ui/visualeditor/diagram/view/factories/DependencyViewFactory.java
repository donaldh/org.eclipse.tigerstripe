 ...
 * @generated
 */
public class DependencyViewFactory extends TigerstripeConnectionViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = TigerstripeVisualIDRegistry
					.getType(org.eclipse.tigerstripe.workbench.ui.visualeditor.diagram.edit.parts.DependencyEditPart.VISUAL_ID);
		...
		getViewService().createNode(
				...
				view,
				TigerstripeVisualIDRegistry
						.getType(DependencyStereotypesEditPart.VISUAL_ID),
				ViewUtil.APPEND, true, getPreferencesHint());
	}
