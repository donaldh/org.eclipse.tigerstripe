...
public class AssociationAEndNameEditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(TigerstripeVisualIDRegistry
				.getType(AssociationAEndNameEditPart.VISUAL_ID), new Point(0,
				-15));
	}
	 ...
	 * @generated
	 */
	public AssociationAEndNameEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new AssociationAEndNameFigure();
	}

	/**
	 * @generated
	 */
	public class AssociationAEndNameFigure extends
			org.eclipse.gmf.runtime.draw2d.ui.figures.WrapLabel {

		/**
		 * @generated
		 */
		public AssociationAEndNameFigure() {

			this.setText("<...>");
			this.setFont(ASSOCIATIONAENDNAMEFIGURE_FONT);
			createContents();
		}
	 ...
	 * @generated NOT
	 */
	public static final org.eclipse.swt.graphics.Font ASSOCIATIONAENDNAMEFIGURE_FONT = new org.eclipse.swt.graphics.Font(
