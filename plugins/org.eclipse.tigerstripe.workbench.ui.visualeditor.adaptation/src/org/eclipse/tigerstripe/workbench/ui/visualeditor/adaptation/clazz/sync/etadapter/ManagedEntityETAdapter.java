...
public class ManagedEntityETAdapter extends AbstractArtifactETAdapter {

	public ManagedEntityETAdapter(ManagedEntityArtifact entity,
			IModelUpdater modelUpdater, ClassDiagramSynchronizer synchronizer) {
		super(entity, modelUpdater, synchronizer);
	}
