...
public class TestReferenceResolutions {
	...
	public static void setup() throws Exception {
		jProject1 = Helper.createJavaProject(PROJECTNAME1);
		...
		jProject2 = Helper.createJavaProject(PROJECTNAME2);
	...
	public static void tearDown() throws Exception {
		Helper.tearDown(jProject1);
		Helper.tearDown(jProject2);
	}
