...
public class ModelSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ModelPackage.HIBERNATE: {
				Hibernate hibernate = (Hibernate)theEObject;
				T result = caseHibernate(hibernate);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModelPackage.MIME_TYPE: {
			...
			case ModelPackage.DAY_LIST: {
				DayList dayList = (DayList)theEObject;
				T result = caseDayList(dayList);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Hibernate</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Hibernate</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseHibernate(Hibernate object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Day List</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Day List</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
