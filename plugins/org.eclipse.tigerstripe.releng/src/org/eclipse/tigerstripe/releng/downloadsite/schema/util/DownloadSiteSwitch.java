 ...
 * @generated
 */
public class DownloadSiteSwitch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case DownloadSitePackage.BUILD: {
				...
				if (result == null) result = caseDownloadSiteElement(build);
			...
			case DownloadSitePackage.BUNDLE: {
				...
				if (result == null) result = caseDownloadSiteElement(bundle);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DownloadSitePackage.COMPONENT: {
				...
				if (result == null) result = caseDownloadSiteElement(component);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DownloadSitePackage.DEPENDENCY: {
				...
				if (result == null) result = caseBundle(dependency);
				if (result == null) result = caseDownloadSiteElement(dependency);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case DownloadSitePackage.DOWNLOAD_SITE: {
				...
				if (result == null) result = caseDownloadSiteElement(downloadSite);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DownloadSitePackage.DOWNLOAD_SITE_ELEMENT: {
				DownloadSiteElement downloadSiteElement = (DownloadSiteElement)theEObject;
				T result = caseDownloadSiteElement(downloadSiteElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Download Site</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Download Site</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDownloadSite(DownloadSite object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseDownloadSiteElement(DownloadSiteElement object) {
		return null;
	}
