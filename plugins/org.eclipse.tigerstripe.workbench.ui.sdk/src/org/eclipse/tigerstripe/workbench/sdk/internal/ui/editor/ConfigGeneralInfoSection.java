...
public class ConfigGeneralInfoSection extends ExtensionSectionPart {
	...
	public ConfigGeneralInfoSection(TigerstripeFormPage page,
			Composite parent, FormToolkit toolkit,
			IExtensionFormContentProvider contentProvider) {
		super(page, parent, toolkit, contentProvider, SWT.NONE);
...
//	}
	...
	private void createQualifiedName(Composite parent, FormToolkit toolkit) {
		...
		packageText = toolkit.createText(parent, "");
	...
	private void createDescription(Composite parent, FormToolkit toolkit) {
		...
		descriptionText = toolkit.createText(parent, "", SWT.WRAP | SWT.MULTI | SWT.V_SCROLL);
		td = new TableWrapData(TableWrapData.FILL_GRAB);
	...
	private void createIsAbstractButton(Composite parent, FormToolkit toolkit) {
		...
		isAbstractButton.setEnabled(false);
