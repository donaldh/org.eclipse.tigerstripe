...
public class AnnotationPackageLabelDetailsPage implements IDetailsPage {


	/**
	 * An adapter that will listen for changes on the form
	 */
	private class AnnotationPackageLabelDetailsPageListener implements ModifyListener,
	...
	private AnnotationPackageLabelSection master;

	private AnnotationPackageLabelContribution contribution;
	...
	public AnnotationPackageLabelDetailsPage() {
		super();
	...
	// ============================================================
	private void setContribution(AnnotationPackageLabelContribution contribution) {
		this.contribution = contribution;
	}

	private AnnotationPackageLabelContribution getContribution() {
		return contribution;
	}
	...
	private void createContributionInfo(Composite parent) {
		...
		AnnotationPackageLabelDetailsPageListener adapter = new AnnotationPackageLabelDetailsPageListener();
...
//		label.setEnabled(!isReadOnly);
	...
	public void selectionChanged(IFormPart part, ISelection selection) {
		if (part instanceof AnnotationPackageLabelSection) {
			//if (nameEditListener != null)
			//	nameEditListener.reset();

			master = (AnnotationPackageLabelSection) part;
			Table fieldsTable = master.getViewer().getTable();

			AnnotationPackageLabelContribution selected = (AnnotationPackageLabelContribution) fieldsTable.getSelection()[0].getData();
